...
public class PaintingVariants {
    ...
    private static void register(BootstrapContext<PaintingVariant> bootstrapContext, ResourceKey<PaintingVariant> resourceKey, int n, int n2) {
        PaintingVariants.register(bootstrapContext, resourceKey, n, n2, true);
    }

    private static void register(BootstrapContext<PaintingVariant> bootstrapContext, ResourceKey<PaintingVariant> resourceKey, int n, int n2, boolean bl) {
        bootstrapContext.register(resourceKey, new PaintingVariant(n, n2, resourceKey.location(), Optional.of(Component.translatable(resourceKey.location().toLanguageKey("painting", "title")).withStyle(ChatFormatting.YELLOW)), bl ? Optional.of(Component.translatable(resourceKey.location().toLanguageKey("painting", "author")).withStyle(ChatFormatting.GRAY)) : Optional.empty()));
    }
