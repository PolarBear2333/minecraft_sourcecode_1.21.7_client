...
extends Goal {
    ...
    private void enchant(Skeleton skeleton, EquipmentSlot equipmentSlot, DifficultyInstance difficultyInstance) {
        ...
        EnchantmentHelper.enchantItemFromProvider(itemStack, skeleton.level().registryAccess(), VanillaEnchantmentProviders.MOB_SPAWN_EQUIPMENT, difficultyInstance, skeleton.getRandom());
