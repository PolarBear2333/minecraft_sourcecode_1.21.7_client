...
public class BuiltInLootTables {
    ...
    private static Map<DyeColor, ResourceKey<LootTable>> makeDyeKeyMap(String string) {
        return Util.makeEnumMap(DyeColor.class, dyeColor -> BuiltInLootTables.register(string + "/" + dyeColor.getName()));
    }

    private static ResourceKey<LootTable> register(String string) {
        return BuiltInLootTables.register(ResourceKey.create(Registries.LOOT_TABLE, ResourceLocation.withDefaultNamespace(string)));
    }
