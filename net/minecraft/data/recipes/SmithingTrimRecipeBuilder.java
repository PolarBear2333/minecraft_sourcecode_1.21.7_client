...
public class SmithingTrimRecipeBuilder {
    ...
    public SmithingTrimRecipeBuilder(RecipeCategory recipeCategory, Ingredient ingredient, Ingredient ingredient2, Ingredient ingredient3, Holder<TrimPattern> holder) {
    ...
    public static SmithingTrimRecipeBuilder smithingTrim(Ingredient ingredient, Ingredient ingredient2, Ingredient ingredient3, Holder<TrimPattern> holder, RecipeCategory recipeCategory) {
