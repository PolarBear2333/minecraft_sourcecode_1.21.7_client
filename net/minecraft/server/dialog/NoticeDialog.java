...
public record NoticeDialog(CommonDialogData common, ActionButton action) implements SimpleDialog
{
    ...
    public static final MapCodec<NoticeDialog> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)CommonDialogData.MAP_CODEC.forGetter(NoticeDialog::common), (App)ActionButton.CODEC.optionalFieldOf("action", (Object)DEFAULT_ACTION).forGetter(NoticeDialog::action)).apply((Applicative)instance, NoticeDialog::new));
