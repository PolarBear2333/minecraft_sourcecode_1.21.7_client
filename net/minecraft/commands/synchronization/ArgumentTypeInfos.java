...
public class ArgumentTypeInfos {
    ...
    private static <A extends ArgumentType<?>, T extends ArgumentTypeInfo.Template<A>> ArgumentTypeInfo<A, T> register(Registry<ArgumentTypeInfo<?, ?>> registry, String string, Class<? extends A> clazz, ArgumentTypeInfo<A, T> argumentTypeInfo) {
        BY_CLASS.put(clazz, argumentTypeInfo);
    ...
    public static <A extends ArgumentType<?>> ArgumentTypeInfo<A, ?> byClass(A a) {
        ArgumentTypeInfo<?, ?> argumentTypeInfo = BY_CLASS.get(a.getClass());
    ...
    public static <A extends ArgumentType<?>> ArgumentTypeInfo.Template<A> unpack(A a) {
        return ArgumentTypeInfos.byClass(a).unpack(a);
    }
}
