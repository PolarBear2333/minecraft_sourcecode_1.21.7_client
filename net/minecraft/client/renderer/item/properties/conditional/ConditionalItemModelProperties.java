...
public class ConditionalItemModelProperties {
    ...
    public static final MapCodec<ConditionalItemModelProperty> MAP_CODEC = ID_MAPPER.codec(ResourceLocation.CODEC).dispatchMap("property", ConditionalItemModelProperty::type, mapCodec -> mapCodec);
