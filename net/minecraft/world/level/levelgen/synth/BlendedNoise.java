...
implements DensityFunction.SimpleFunction {
    ...
    private static final MapCodec<BlendedNoise> DATA_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)SCALE_RANGE.fieldOf("xz_scale").forGetter(blendedNoise -> blendedNoise.xzScale), (App)SCALE_RANGE.fieldOf("y_scale").forGetter(blendedNoise -> blendedNoise.yScale), (App)SCALE_RANGE.fieldOf("xz_factor").forGetter(blendedNoise -> blendedNoise.xzFactor), (App)SCALE_RANGE.fieldOf("y_factor").forGetter(blendedNoise -> blendedNoise.yFactor), (App)Codec.doubleRange((double)1.0, (double)8.0).fieldOf("smear_scale_multiplier").forGetter(blendedNoise -> blendedNoise.smearScaleMultiplier)).apply((Applicative)instance, BlendedNoise::createUnseeded));
