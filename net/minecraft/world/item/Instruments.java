...
public interface Instruments {
    ...
    public static void register(BootstrapContext<Instrument> bootstrapContext, ResourceKey<Instrument> resourceKey, Holder<SoundEvent> holder, float f, float f2) {
        MutableComponent mutableComponent = Component.translatable(Util.makeDescriptionId("instrument", resourceKey.location()));
        bootstrapContext.register(resourceKey, new Instrument(holder, f, f2, mutableComponent));
    }
}
