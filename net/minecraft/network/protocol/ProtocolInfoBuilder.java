...
public class ProtocolInfoBuilder<T extends PacketListener, B extends ByteBuf, C> {
    ...
    public <P extends BundlePacket<? super T>, D extends BundleDelimiterPacket<? super T>> ProtocolInfoBuilder<T, B, C> withBundlePacket(PacketType<P> packetType, Function<Iterable<Packet<? super T>>, P> function, D d) {
    ...
    StreamCodec<ByteBuf, Packet<? super T>> buildPacketCodec(Function<ByteBuf, B> function, List<CodecEntry<T, ?, B, C>> list, C c) {
        ...
        for (CodecEntry codecEntry : list) {
            codecEntry.addToBuilder(protocolCodecBuilder, function, c);
        }
    ...
    public SimpleUnboundProtocol<T, B> buildUnbound(final C c) {
        ...
        return new SimpleUnboundProtocol<T, B>(){
            ...
            public ProtocolInfo<T> bind(Function<ByteBuf, B> function) {
                return new Implementation(ProtocolInfoBuilder.this.protocol, ProtocolInfoBuilder.this.flow, ProtocolInfoBuilder.this.buildPacketCodec(function, list, c), bundlerInfo);
            }
    ...
    public UnboundProtocol<T, B, C> buildUnbound() {
        ...
        return new UnboundProtocol<T, B, C>(){
            ...
            @Override
            public ProtocolInfo<T> bind(Function<ByteBuf, B> function, C c) {
                return new Implementation(ProtocolInfoBuilder.this.protocol, ProtocolInfoBuilder.this.flow, ProtocolInfoBuilder.this.buildPacketCodec(function, list, c), bundlerInfo);
            }
    ...
    extends Record {
        ...
        public void addToBuilder(ProtocolCodecBuilder<ByteBuf, T> protocolCodecBuilder, Function<ByteBuf, B> function, C c) {
            StreamCodec<Object, P> streamCodec = this.modifier != null ? this.modifier.apply(this.serializer, c) : this.serializer;
