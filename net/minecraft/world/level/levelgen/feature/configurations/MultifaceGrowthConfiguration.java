...
implements FeatureConfiguration {
    ...
    public MultifaceGrowthConfiguration(MultifaceSpreadeableBlock multifaceSpreadeableBlock, int n, boolean bl, boolean bl2, boolean bl3, float f, HolderSet<Block> holderSet) {
