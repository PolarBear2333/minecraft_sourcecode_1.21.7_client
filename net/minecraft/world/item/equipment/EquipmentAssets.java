...
public interface EquipmentAssets {
    ...
    public static final Map<DyeColor, ResourceKey<EquipmentAsset>> CARPETS = Util.makeEnumMap(DyeColor.class, dyeColor -> EquipmentAssets.createId(dyeColor.getSerializedName() + "_carpet"));
    public static final ResourceKey<EquipmentAsset> TRADER_LLAMA = EquipmentAssets.createId("trader_llama");
    public static final Map<DyeColor, ResourceKey<EquipmentAsset>> HARNESSES = Util.makeEnumMap(DyeColor.class, dyeColor -> EquipmentAssets.createId(dyeColor.getSerializedName() + "_harness"));
