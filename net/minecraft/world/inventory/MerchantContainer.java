...
implements Container {
    ...
    public void updateSellItem() {
        ...
        if (this.itemStacks.get(0).isEmpty()) {
            ...
            itemStack2 = this.itemStacks.get(0);
        ...
        if (!merchantOffers.isEmpty()) {
            MerchantOffer merchantOffer = merchantOffers.getRecipeFor(itemStack2, itemStack, this.selectionHint);
            if (merchantOffer == null || merchantOffer.isOutOfStock()) {
                this.activeOffer = merchantOffer;
                merchantOffer = merchantOffers.getRecipeFor(itemStack, itemStack2, this.selectionHint);
            }
            if (merchantOffer != null && !merchantOffer.isOutOfStock()) {
                this.activeOffer = merchantOffer;
