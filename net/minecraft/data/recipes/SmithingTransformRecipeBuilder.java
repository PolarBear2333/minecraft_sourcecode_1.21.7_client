...
public class SmithingTransformRecipeBuilder {
    ...
    public void save(RecipeOutput recipeOutput, ResourceKey<Recipe<?>> resourceKey) {
        ...
        SmithingTransformRecipe smithingTransformRecipe = new SmithingTransformRecipe(Optional.of(this.template), this.base, Optional.of(this.addition), new TransmuteResult(this.result));
