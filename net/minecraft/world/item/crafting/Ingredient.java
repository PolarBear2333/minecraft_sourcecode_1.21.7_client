...
Predicate<ItemStack> {
    ...
    public static Ingredient of(ItemLike ... itemLikeArray) {
        return Ingredient.of(Arrays.stream(itemLikeArray));
    }
    ...
    private static SlotDisplay displayForSingleItem(Holder<Item> holder) {
        ...
        if (!itemStack.isEmpty()) {
            SlotDisplay.ItemStackSlotDisplay itemStackSlotDisplay = new SlotDisplay.ItemStackSlotDisplay(itemStack);
            return new SlotDisplay.WithRemainder(itemSlotDisplay, itemStackSlotDisplay);
        }
