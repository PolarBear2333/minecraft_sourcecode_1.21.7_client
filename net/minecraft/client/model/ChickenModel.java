...
extends EntityModel<ChickenRenderState> {
    ...
    public void setupAnim(ChickenRenderState chickenRenderState) {
        ...
        float f2 = chickenRenderState.walkAnimationSpeed;
        float f3 = chickenRenderState.walkAnimationPos;
        this.rightLeg.xRot = Mth.cos(f3 * 0.6662f) * 1.4f * f2;
        this.leftLeg.xRot = Mth.cos(f3 * 0.6662f + (float)Math.PI) * 1.4f * f2;
