...
implements Toast {
    ...
    public static SystemToast multiline(Minecraft minecraft, SystemToastId systemToastId, Component component, Component component2) {
        ...
        return new SystemToast(systemToastId, component, list, n + 30);
    }

    private SystemToast(SystemToastId systemToastId, Component component, List<FormattedCharSequence> list, int n) {
    ...
    public void update(ToastManager toastManager, long l) {
        ...
        long l2 = l - this.lastChanged;
        this.wantedVisibility = !this.forceHide && (double)l2 < d ? Toast.Visibility.SHOW : Toast.Visibility.HIDE;
    }
    ...
    public static void onFileDropFailure(Minecraft minecraft, int n) {
        SystemToast.add(minecraft.getToastManager(), SystemToastId.FILE_DROP_FAILURE, Component.translatable("gui.fileDropFailure.title"), Component.translatable("gui.fileDropFailure.detail", n));
    }
