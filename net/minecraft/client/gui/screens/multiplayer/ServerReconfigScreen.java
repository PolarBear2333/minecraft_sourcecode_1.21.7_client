...
extends Screen {
    ...
    protected void init() {
        ...
        this.disconnectButton = this.layout.addChild(Button.builder(CommonComponents.GUI_DISCONNECT, button -> this.connection.disconnect(ConnectScreen.ABORT_CONNECTION)).build());
