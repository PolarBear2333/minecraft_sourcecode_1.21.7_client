...
public class StringSplitter {
    ...
    public int formattedIndexByWidth(String string, int n, Style style) {
        WidthLimitedCharSink widthLimitedCharSink = new WidthLimitedCharSink(n);
    ...
    public String formattedHeadByWidth(String string, int n, Style style) {
        return string.substring(0, this.formattedIndexByWidth(string, n, style));
    }
    ...
    public int findLineBreak(String string, int n, Style style) {
    ...
    public List<FormattedText> splitLines(FormattedText formattedText2, int n, Style style) {
        ArrayList arrayList = Lists.newArrayList();
        this.splitLines(formattedText2, n, style, (FormattedText formattedText, Boolean bl) -> arrayList.add(formattedText));
        return arrayList;
    }

    public List<FormattedText> splitLines(FormattedText formattedText, int n, Style style, FormattedText formattedText3) {
        ArrayList arrayList = Lists.newArrayList();
        this.splitLines(formattedText, n, style, (FormattedText formattedText2, Boolean bl) -> arrayList.add(bl != false ? FormattedText.composite(formattedText3, formattedText2) : formattedText2));
        return arrayList;
    }
