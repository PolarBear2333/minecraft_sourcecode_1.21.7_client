...
extends RealmsScreen {
    ...
    private void drawIcons(GuiGraphics guiGraphics) {
        ...
        if (hasUnseenNotifications) {
            guiGraphics.blitSprite(RenderPipelines.GUI_TEXTURED, UNSEEN_NOTIFICATION_SPRITE, n6 - 12, n5 + 3, 10, 10);
            n6 -= 16;
        }
        if (this.currentConfiguration != null && this.currentConfiguration.showOldNotifications()) {
            if (hasUnreadNews) {
                guiGraphics.blitSprite(RenderPipelines.GUI_TEXTURED, NEWS_SPRITE, n6 - 14, n5 + 1, 14, 14);
                n6 -= 16;
            }
            if (n != 0) {
                guiGraphics.blitSprite(RenderPipelines.GUI_TEXTURED, INVITE_SPRITE, n6 - 14, n5 + 1, 14, 14);
                n6 -= 16;
            }
            if (trialAvailable) {
                guiGraphics.blitSprite(RenderPipelines.GUI_TEXTURED, TRIAL_AVAILABLE_SPRITE, n6 - 10, n5 + 4, 8, 8);
            }
        }
    }
