...
extends Screen {
    ...
    public static CycleButton<Difficulty> createDifficultyButton(int n, int n2, String string, Minecraft minecraft) {
        return CycleButton.builder(Difficulty::getDisplayName).withValues((Difficulty[])Difficulty.values()).withInitialValue(minecraft.level.getDifficulty()).create(n, n2, 150, 20, Component.translatable(string), (cycleButton, difficulty) -> minecraft.getConnection().send(new ServerboundChangeDifficultyPacket((Difficulty)difficulty)));
    }
