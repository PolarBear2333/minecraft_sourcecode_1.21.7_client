...
public class ParticleTypes {
    ...
    public static final ParticleType<DustParticleOptions> DUST = ParticleTypes.register("dust", false, particleType -> DustParticleOptions.CODEC, particleType -> DustParticleOptions.STREAM_CODEC);
    public static final ParticleType<DustColorTransitionOptions> DUST_COLOR_TRANSITION = ParticleTypes.register("dust_color_transition", false, particleType -> DustColorTransitionOptions.CODEC, particleType -> DustColorTransitionOptions.STREAM_CODEC);
    ...
    public static final ParticleType<SculkChargeParticleOptions> SCULK_CHARGE = ParticleTypes.register("sculk_charge", true, particleType -> SculkChargeParticleOptions.CODEC, particleType -> SculkChargeParticleOptions.STREAM_CODEC);
    ...
    public static final ParticleType<VibrationParticleOption> VIBRATION = ParticleTypes.register("vibration", true, particleType -> VibrationParticleOption.CODEC, particleType -> VibrationParticleOption.STREAM_CODEC);
    public static final ParticleType<TrailParticleOption> TRAIL = ParticleTypes.register("trail", false, particleType -> TrailParticleOption.CODEC, particleType -> TrailParticleOption.STREAM_CODEC);
    ...
    public static final ParticleType<ShriekParticleOption> SHRIEK = ParticleTypes.register("shriek", false, particleType -> ShriekParticleOption.CODEC, particleType -> ShriekParticleOption.STREAM_CODEC);
