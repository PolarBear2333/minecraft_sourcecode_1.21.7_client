...
public class TreeNodePosition {
    ...
    public TreeNodePosition(AdvancementNode advancementNode, @Nullable TreeNodePosition treeNodePosition, @Nullable TreeNodePosition treeNodePosition2, int n, int n2) {
