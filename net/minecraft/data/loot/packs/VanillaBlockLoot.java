...
extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        HolderGetter holderGetter2 = this.registries.lookupOrThrow(Registries.ITEM);
        ...
        this.add(Blocks.PALE_MOSS_CARPET, (Block block) -> this.createMossyCarpetBlockDrops((Block)block));
        this.add(Blocks.PALE_HANGING_MOSS, (Block itemLike) -> this.createShearsOrSilkTouchOnlyDrop((ItemLike)itemLike));
        ...
        this.add(Blocks.TUFF_SLAB, (Block block) -> this.createSlabItemTable((Block)block));
        this.add(Blocks.TUFF_BRICK_SLAB, (Block block) -> this.createSlabItemTable((Block)block));
        this.add(Blocks.POLISHED_TUFF_SLAB, (Block block) -> this.createSlabItemTable((Block)block));
        ...
        this.add(Blocks.PALE_OAK_SLAB, (Block block) -> this.createSlabItemTable((Block)block));
        ...
        this.add(Blocks.RESIN_BRICK_SLAB, (Block block) -> this.createSlabItemTable((Block)block));
        ...
        this.add(Blocks.PALE_OAK_DOOR, (Block block) -> this.createDoorTable((Block)block));
        ...
        this.add(Blocks.COPPER_DOOR, (Block block) -> this.createDoorTable((Block)block));
        this.add(Blocks.EXPOSED_COPPER_DOOR, (Block block) -> this.createDoorTable((Block)block));
        this.add(Blocks.WEATHERED_COPPER_DOOR, (Block block) -> this.createDoorTable((Block)block));
        this.add(Blocks.OXIDIZED_COPPER_DOOR, (Block block) -> this.createDoorTable((Block)block));
        this.add(Blocks.WAXED_COPPER_DOOR, (Block block) -> this.createDoorTable((Block)block));
        this.add(Blocks.WAXED_EXPOSED_COPPER_DOOR, (Block block) -> this.createDoorTable((Block)block));
        this.add(Blocks.WAXED_WEATHERED_COPPER_DOOR, (Block block) -> this.createDoorTable((Block)block));
        this.add(Blocks.WAXED_OXIDIZED_COPPER_DOOR, (Block block) -> this.createDoorTable((Block)block));
        ...
        this.add(Blocks.SEA_PICKLE, (Block block) -> LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0f)).add((LootPoolEntryContainer.Builder)this.applyExplosionDecay(Blocks.SEA_PICKLE, LootItem.lootTableItem(block).apply(List.of(Integer.valueOf(2), Integer.valueOf(3), Integer.valueOf(4)), n -> SetItemCountFunction.setCount(ConstantValue.exactly(n.intValue())).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(SeaPickleBlock.PICKLES, n.intValue()))))))));
        ...
        this.add(Blocks.CAVE_VINES, (Block block) -> this.createCaveVinesDrop((Block)block));
        this.add(Blocks.CAVE_VINES_PLANT, (Block block) -> this.createCaveVinesDrop((Block)block));
        ...
        this.add(Blocks.PLAYER_HEAD, (Block block) -> LootTable.lootTable().withPool(this.applyExplosionCondition((ItemLike)block, LootPool.lootPool().setRolls(ConstantValue.exactly(1.0f)).add((LootPoolEntryContainer.Builder<?>)((Object)LootItem.lootTableItem(block).apply(CopyComponentsFunction.copyComponents(CopyComponentsFunction.Source.BLOCK_ENTITY).include(DataComponents.PROFILE).include(DataComponents.NOTE_BLOCK_SOUND).include(DataComponents.CUSTOM_NAME)))))));
        this.add(Blocks.BEE_NEST, (Block block) -> this.createBeeNestDrop((Block)block));
        this.add(Blocks.BEEHIVE, (Block block) -> this.createBeeHiveDrop((Block)block));
        ...
        this.add(Blocks.CARROTS, this.applyExplosionDecay(Blocks.CARROTS, LootTable.lootTable().withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.CARROT))).withPool(LootPool.lootPool().when(builder3).add((LootPoolEntryContainer.Builder<?>)((Object)LootItem.lootTableItem(Items.CARROT).apply(ApplyBonusCount.addBonusBinomialDistributionCount(holderGetter.getOrThrow(Enchantments.FORTUNE), 0.5714286f, 3)))))));
        ...
        this.add(Blocks.POTATOES, this.applyExplosionDecay(Blocks.POTATOES, LootTable.lootTable().withPool(LootPool.lootPool().add(LootItem.lootTableItem(Items.POTATO))).withPool(LootPool.lootPool().when(builder5).add((LootPoolEntryContainer.Builder<?>)((Object)LootItem.lootTableItem(Items.POTATO).apply(ApplyBonusCount.addBonusBinomialDistributionCount(holderGetter.getOrThrow(Enchantments.FORTUNE), 0.5714286f, 3))))).withPool(LootPool.lootPool().when(builder5).add((LootPoolEntryContainer.Builder<?>)LootItem.lootTableItem(Items.POISONOUS_POTATO).when(LootItemRandomChanceCondition.randomChance(0.02f))))));
        this.add(Blocks.SWEET_BERRY_BUSH, arg_0 -> this.lambda$generate$204((HolderLookup.RegistryLookup)holderGetter, arg_0));
        ...
        this.add(Blocks.NETHER_GOLD_ORE, arg_0 -> this.lambda$generate$220((HolderLookup.RegistryLookup)holderGetter, arg_0));
        ...
        this.add(Blocks.SHORT_DRY_GRASS, (Block itemLike) -> this.createShearsOrSilkTouchOnlyDrop((ItemLike)itemLike));
        this.add(Blocks.TALL_DRY_GRASS, (Block itemLike) -> this.createShearsOrSilkTouchOnlyDrop((ItemLike)itemLike));
        this.add(Blocks.BUSH, (Block itemLike) -> this.createShearsOrSilkTouchOnlyDrop((ItemLike)itemLike));
        this.add(Blocks.NETHER_SPROUTS, (Block itemLike) -> this.createShearsOnlyDrop((ItemLike)itemLike));
        this.add(Blocks.SEAGRASS, (Block itemLike) -> this.createShearsOnlyDrop((ItemLike)itemLike));
        this.add(Blocks.VINE, (Block itemLike) -> this.createShearsOnlyDrop((ItemLike)itemLike));
        this.add(Blocks.GLOW_LICHEN, (Block block) -> this.createMultifaceBlockDrops((Block)block, this.hasShears()));
        this.add(Blocks.RESIN_CLUMP, (Block block) -> this.createMultifaceBlockDrops((Block)block));
        this.add(Blocks.HANGING_ROOTS, (Block itemLike) -> this.createShearsOnlyDrop((ItemLike)itemLike));
        this.add(Blocks.SMALL_DRIPLEAF, (Block itemLike) -> this.createShearsOnlyDrop((ItemLike)itemLike));
        ...
        this.add(Blocks.SHORT_GRASS, (Block block) -> this.createGrassDrops((Block)block));
        this.add(Blocks.GLOWSTONE, arg_0 -> this.lambda$generate$245((HolderLookup.RegistryLookup)holderGetter, arg_0));
        this.add(Blocks.MELON, arg_0 -> this.lambda$generate$246((HolderLookup.RegistryLookup)holderGetter, arg_0));
        ...
        this.add(Blocks.SEA_LANTERN, arg_0 -> this.lambda$generate$249((HolderLookup.RegistryLookup)holderGetter, arg_0));
        this.add(Blocks.CREAKING_HEART, arg_0 -> this.lambda$generate$250((HolderLookup.RegistryLookup)holderGetter, arg_0));
        this.add(Blocks.NETHER_WART, arg_0 -> this.lambda$generate$251((HolderLookup.RegistryLookup)holderGetter, arg_0));
        this.add(Blocks.SNOW, (Block block) -> LootTable.lootTable().withPool(LootPool.lootPool().when(LootItemEntityPropertyCondition.entityPresent(LootContext.EntityTarget.THIS)).add(AlternativesEntry.alternatives(new LootPoolEntryContainer.Builder[]{AlternativesEntry.alternatives(SnowLayerBlock.LAYERS.getPossibleValues(), n -> ((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.SNOWBALL).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(SnowLayerBlock.LAYERS, n.intValue())))).apply(SetItemCountFunction.setCount(ConstantValue.exactly(n.intValue())))).when(this.doesNotHaveSilkTouch()), AlternativesEntry.alternatives(SnowLayerBlock.LAYERS.getPossibleValues(), n -> n == 8 ? LootItem.lootTableItem(Blocks.SNOW_BLOCK) : ((LootPoolEntryContainer.Builder)((Object)LootItem.lootTableItem(Blocks.SNOW).apply(SetItemCountFunction.setCount(ConstantValue.exactly(n.intValue()))))).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(SnowLayerBlock.LAYERS, n.intValue()))))}))));
        this.add(Blocks.GRAVEL, arg_0 -> this.lambda$generate$255((HolderLookup.RegistryLookup)holderGetter, arg_0));
        ...
        this.add(Blocks.GILDED_BLACKSTONE, arg_0 -> this.lambda$generate$257((HolderLookup.RegistryLookup)holderGetter, arg_0));
        ...
        this.add(Blocks.AMETHYST_CLUSTER, arg_0 -> this.lambda$generate$259((HolderLookup.RegistryLookup)holderGetter, (HolderLookup.RegistryLookup)holderGetter2, arg_0));
    ...
    private LootTable.Builder createDecoratedPotTable(Block block) {
        return LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0f)).add(((LootPoolSingletonContainer.Builder)DynamicLoot.dynamicEntry(DecoratedPotBlock.SHERDS_DYNAMIC_DROP_ID).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(DecoratedPotBlock.CRACKED, true)))).otherwise((LootPoolEntryContainer.Builder<?>)((Object)LootItem.lootTableItem(block).apply(CopyComponentsFunction.copyComponents(CopyComponentsFunction.Source.BLOCK_ENTITY).include(DataComponents.POT_DECORATIONS))))));
    }

    private LootTable.Builder createPitcherCropLoot() {
        return this.applyExplosionDecay(Blocks.PITCHER_CROP, LootTable.lootTable().withPool(LootPool.lootPool().add(AlternativesEntry.alternatives(PitcherCropBlock.AGE.getPossibleValues(), n -> {
            LootItemBlockStatePropertyCondition.Builder builder = LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.PITCHER_CROP).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(DoublePlantBlock.HALF, DoubleBlockHalf.LOWER));
            LootItemBlockStatePropertyCondition.Builder builder2 = LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.PITCHER_CROP).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(PitcherCropBlock.AGE, n.intValue()));
            if (n == 4) {
                return ((LootPoolSingletonContainer.Builder)((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.PITCHER_PLANT).when(builder2)).when(builder)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0f)));
            }
            return ((LootPoolSingletonContainer.Builder)((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.PITCHER_POD).when(builder2)).when(builder)).apply(SetItemCountFunction.setCount(ConstantValue.exactly(1.0f)));
        }))));
    }

    private /* synthetic */ LootTable.Builder lambda$generate$259(HolderLookup.RegistryLookup registryLookup, HolderLookup.RegistryLookup registryLookup2, Block block) {
        return this.createSilkTouchDispatchTable(block, ((LootPoolSingletonContainer.Builder)((LootPoolEntryContainer.Builder)((Object)((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.AMETHYST_SHARD).apply(SetItemCountFunction.setCount(ConstantValue.exactly(4.0f)))).apply(ApplyBonusCount.addOreBonusCount(registryLookup.getOrThrow(Enchantments.FORTUNE))))).when(MatchTool.toolMatches(ItemPredicate.Builder.item().of((HolderGetter<Item>)registryLookup2, ItemTags.CLUSTER_MAX_HARVESTABLES)))).otherwise((LootPoolEntryContainer.Builder)this.applyExplosionDecay(block, LootItem.lootTableItem(Items.AMETHYST_SHARD).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0f))))));
    }

    private /* synthetic */ LootTable.Builder lambda$generate$257(HolderLookup.RegistryLookup registryLookup, Block block) {
        return this.createSilkTouchDispatchTable(block, this.applyExplosionCondition(block, ((LootPoolSingletonContainer.Builder)((LootPoolEntryContainer.Builder)((Object)LootItem.lootTableItem(Items.GOLD_NUGGET).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0f, 5.0f))))).when(BonusLevelTableCondition.bonusLevelFlatChance(registryLookup.getOrThrow(Enchantments.FORTUNE), 0.1f, 0.14285715f, 0.25f, 1.0f))).otherwise(LootItem.lootTableItem(block))));
    }

    private /* synthetic */ LootTable.Builder lambda$generate$255(HolderLookup.RegistryLookup registryLookup, Block block) {
        return this.createSilkTouchDispatchTable(block, this.applyExplosionCondition(block, ((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.FLINT).when(BonusLevelTableCondition.bonusLevelFlatChance(registryLookup.getOrThrow(Enchantments.FORTUNE), 0.1f, 0.14285715f, 0.25f, 1.0f))).otherwise(LootItem.lootTableItem(block))));
    }

    private /* synthetic */ LootTable.Builder lambda$generate$251(HolderLookup.RegistryLookup registryLookup, Block block) {
        return LootTable.lootTable().withPool(this.applyExplosionDecay(block, LootPool.lootPool().setRolls(ConstantValue.exactly(1.0f)).add((LootPoolEntryContainer.Builder<?>)((Object)((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.NETHER_WART).apply((LootItemFunction.Builder)((Object)SetItemCountFunction.setCount(UniformGenerator.between(2.0f, 4.0f)).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(NetherWartBlock.AGE, 3)))))).apply((LootItemFunction.Builder)((Object)ApplyBonusCount.addUniformBonusCount(registryLookup.getOrThrow(Enchantments.FORTUNE)).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(NetherWartBlock.AGE, 3)))))))));
    }

    private /* synthetic */ LootTable.Builder lambda$generate$250(HolderLookup.RegistryLookup registryLookup, Block block) {
        return this.createSilkTouchDispatchTable(block, (LootPoolEntryContainer.Builder)this.applyExplosionDecay(block, ((LootPoolSingletonContainer.Builder)((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.RESIN_CLUMP).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0f, 3.0f)))).apply(ApplyBonusCount.addUniformBonusCount(registryLookup.getOrThrow(Enchantments.FORTUNE)))).apply(LimitCount.limitCount(IntRange.upperBound(9)))));
    }

    private /* synthetic */ LootTable.Builder lambda$generate$249(HolderLookup.RegistryLookup registryLookup, Block block) {
        return this.createSilkTouchDispatchTable(block, (LootPoolEntryContainer.Builder)this.applyExplosionDecay(block, ((LootPoolSingletonContainer.Builder)((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.PRISMARINE_CRYSTALS).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0f, 3.0f)))).apply(ApplyBonusCount.addUniformBonusCount(registryLookup.getOrThrow(Enchantments.FORTUNE)))).apply(LimitCount.limitCount(IntRange.range(1, 5)))));
    }

    private /* synthetic */ LootTable.Builder lambda$generate$246(HolderLookup.RegistryLookup registryLookup, Block block) {
        return this.createSilkTouchDispatchTable(block, (LootPoolEntryContainer.Builder)this.applyExplosionDecay(block, ((LootPoolSingletonContainer.Builder)((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.MELON_SLICE).apply(SetItemCountFunction.setCount(UniformGenerator.between(3.0f, 7.0f)))).apply(ApplyBonusCount.addUniformBonusCount(registryLookup.getOrThrow(Enchantments.FORTUNE)))).apply(LimitCount.limitCount(IntRange.upperBound(9)))));
    }

    private /* synthetic */ LootTable.Builder lambda$generate$245(HolderLookup.RegistryLookup registryLookup, Block block) {
        return this.createSilkTouchDispatchTable(block, (LootPoolEntryContainer.Builder)this.applyExplosionDecay(block, ((LootPoolSingletonContainer.Builder)((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.GLOWSTONE_DUST).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0f, 4.0f)))).apply(ApplyBonusCount.addUniformBonusCount(registryLookup.getOrThrow(Enchantments.FORTUNE)))).apply(LimitCount.limitCount(IntRange.range(1, 4)))));
    }

    private /* synthetic */ LootTable.Builder lambda$generate$220(HolderLookup.RegistryLookup registryLookup, Block block) {
    ...
    private /* synthetic */ LootTable.Builder lambda$generate$204(HolderLookup.RegistryLookup registryLookup, Block block) {
        return this.applyExplosionDecay(block, LootTable.lootTable().withPool(LootPool.lootPool().when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.SWEET_BERRY_BUSH).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(SweetBerryBushBlock.AGE, 3))).add(LootItem.lootTableItem(Items.SWEET_BERRIES)).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0f, 3.0f))).apply(ApplyBonusCount.addUniformBonusCount(registryLookup.getOrThrow(Enchantments.FORTUNE)))).withPool(LootPool.lootPool().when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.SWEET_BERRY_BUSH).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(SweetBerryBushBlock.AGE, 2))).add(LootItem.lootTableItem(Items.SWEET_BERRIES)).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0f, 2.0f))).apply(ApplyBonusCount.addUniformBonusCount(registryLookup.getOrThrow(Enchantments.FORTUNE)))));
    }
}
