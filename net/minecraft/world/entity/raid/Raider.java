...
extends PatrollingMonster {
    ...
    public void die(DamageSource damageSource) {
        ...
        if (object instanceof ServerLevel) {
            ...
            if (raid != null) {
                ...
                if (object != null && ((Entity)object).getType() == EntityType.PLAYER) {
                    raid.addHeroOfTheVillage((Entity)object);
                }
    ...
    protected void addAdditionalSaveData(ValueOutput valueOutput) {
        ...
        if (this.raid != null && (level = this.level()) instanceof ServerLevel) {
            ServerLevel serverLevel = (ServerLevel)level;
            serverLevel.getRaids().getId(this.raid).ifPresent(n -> valueOutput.putInt("RaidId", n));
        }
    }
    ...
    protected void readAdditionalSaveData(ValueInput valueInput) {
        ...
        if (level instanceof ServerLevel) {
            ServerLevel serverLevel = (ServerLevel)level;
            valueInput.getInt("RaidId").ifPresent(n -> {
                this.raid = serverLevel.getRaids().get((int)n);
                if (this.raid != null) {
    ...
    extends Goal {
        ...
        public boolean canUse() {
            ...
            double d = this.this$0.getAttributeValue(Attributes.FOLLOW_RANGE);
            ...
            for (ItemEntity itemEntity : list) {
                ...
                if (this.this$0.level().getGameTime() < l) {
