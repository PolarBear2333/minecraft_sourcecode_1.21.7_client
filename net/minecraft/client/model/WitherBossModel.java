...
extends EntityModel<WitherRenderState> {
    ...
    private static void setupHeadRotation(WitherRenderState witherRenderState, ModelPart modelPart, int n) {
        modelPart.yRot = (witherRenderState.yHeadRots[n] - witherRenderState.bodyRot) * ((float)Math.PI / 180);
        modelPart.xRot = witherRenderState.xHeadRots[n] * ((float)Math.PI / 180);
    }
}
