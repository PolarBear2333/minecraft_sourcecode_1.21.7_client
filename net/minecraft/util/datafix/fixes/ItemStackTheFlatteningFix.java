...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemInstanceTheFlatteningFix", type, typed -> {
            ...
            int n = dynamic.get("Damage").asInt(0);
            String string = ItemStackTheFlatteningFix.updateItem((String)((Pair)optional.get()).getSecond(), n);
            if (string != null) {
                typed2 = typed2.set(opticFinder, (Object)Pair.of((Object)References.ITEM_NAME.typeName(), (Object)string));
            }
            if (DAMAGE_IDS.contains(((Pair)optional.get()).getSecond())) {
                ...
                dynamic2 = dynamic2.set("Damage", dynamic2.createInt(n));
                typed2 = typed2.set(opticFinder2, typed3.set(DSL.remainderFinder(), (Object)dynamic2));
            }
            typed2 = typed2.set(DSL.remainderFinder(), (Object)dynamic.remove("Damage"));
            return typed2;
        });
    }

    @Nullable
    public static String updateItem(@Nullable String string, int n) {
        if (IDS.contains(string)) {
            String string2 = MAP.get(string + "." + n);
