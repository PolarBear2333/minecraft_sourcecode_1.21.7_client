...
extends Screen {
    ...
    protected void init() {
        ...
        linearLayout.addChild(Button.builder(ATTRIBUTION_BUTTON, ConfirmLinkScreen.confirmLink((Screen)this, CommonLinks.ATTRIBUTION)).width(210).build());
        linearLayout.addChild(Button.builder(LICENSES_BUTTON, ConfirmLinkScreen.confirmLink((Screen)this, CommonLinks.LICENSES)).width(210).build());
