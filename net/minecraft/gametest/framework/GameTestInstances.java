...
public interface GameTestInstances {
    ...
    public static void bootstrap(BootstrapContext<GameTestInstance> bootstrapContext) {
        ...
        bootstrapContext.register(ALWAYS_PASS, new FunctionGameTestInstance(BuiltinTestFunctions.ALWAYS_PASS, new TestData<Holder<TestEnvironmentDefinition>>(holderGetter2.getOrThrow(GameTestEnvironments.DEFAULT_KEY), ResourceLocation.withDefaultNamespace("empty"), 1, 1, false)));
    }
