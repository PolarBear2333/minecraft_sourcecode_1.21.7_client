...
extends Goal {
    ...
    public boolean canUse() {
        ...
        this.villager = OfferFlowerGoal.getServerLevel(this.golem).getNearestEntity(Villager.class, OFFER_TARGER_CONTEXT, this.golem, this.golem.getX(), this.golem.getY(), this.golem.getZ(), this.golem.getBoundingBox().inflate(6.0, 2.0, 6.0));
