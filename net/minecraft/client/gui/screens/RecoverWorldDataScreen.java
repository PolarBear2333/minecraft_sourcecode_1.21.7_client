...
extends Screen {
    ...
    public RecoverWorldDataScreen(Minecraft minecraft, BooleanConsumer booleanConsumer, LevelStorageSource.LevelStorageAccess levelStorageAccess) {
        ...
        MutableComponent mutableComponent = Component.empty().append(this.buildInfo(levelStorageAccess, false, exception)).append("\n").append(this.buildInfo(levelStorageAccess, true, exception2));
        this.issuesWidget = new MultiLineTextWidget(mutableComponent, minecraft.font);
    ...
    private Component buildInfo(LevelStorageSource.LevelStorageAccess levelStorageAccess, boolean bl, @Nullable Exception exception) {
        ...
        MutableComponent mutableComponent2 = instant != null ? Component.literal(WorldSelectionList.DATE_FORMAT.format(instant)) : Component.translatable("recover_world.state_entry.unknown");
