...
public class MoveToSkySeeingSpot {
    public static OneShot<LivingEntity> create(float f) {
        return BehaviorBuilder.create(instance -> instance.group(instance.absent(MemoryModuleType.WALK_TARGET)).apply((Applicative)instance, memoryAccessor -> (serverLevel, livingEntity, l) -> {
