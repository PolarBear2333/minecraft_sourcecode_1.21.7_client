...
public interface DataProvider {
    ...
    public static <T> CompletableFuture<?> saveStable(CachedOutput cachedOutput, HolderLookup.Provider provider, Codec<T> codec, T t, Path path) {
        ...
        return DataProvider.saveStable(cachedOutput, registryOps, codec, t, path);
    }

    public static <T> CompletableFuture<?> saveStable(CachedOutput cachedOutput, Codec<T> codec, T t, Path path) {
        return DataProvider.saveStable(cachedOutput, (DynamicOps<JsonElement>)JsonOps.INSTANCE, codec, t, path);
    }

    private static <T> CompletableFuture<?> saveStable(CachedOutput cachedOutput, DynamicOps<JsonElement> dynamicOps, Codec<T> codec, T t, Path path) {
