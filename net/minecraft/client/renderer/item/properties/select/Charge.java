...
public record Charge() implements SelectItemModelProperty<CrossbowItem.ChargeType>
{
    ...
    @Override
    public CrossbowItem.ChargeType get(ItemStack itemStack, @Nullable ClientLevel clientLevel, @Nullable LivingEntity livingEntity, int n, ItemDisplayContext itemDisplayContext) {
