...
{
    public static final MapCodec<FunctionTagCallback> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)ResourceLocation.CODEC.fieldOf("Name").forGetter(FunctionTagCallback::tagId)).apply((Applicative)instance, FunctionTagCallback::new));
