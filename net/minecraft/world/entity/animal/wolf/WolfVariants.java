...
public class WolfVariants {
    ...
    private static void register(BootstrapContext<WolfVariant> bootstrapContext, ResourceKey<WolfVariant> resourceKey, String string, SpawnPrioritySelectors spawnPrioritySelectors) {
        ...
        bootstrapContext.register(resourceKey, new WolfVariant(new WolfVariant.AssetInfo(new ClientAsset(resourceLocation), new ClientAsset(resourceLocation2), new ClientAsset(resourceLocation3)), spawnPrioritySelectors));
    }
