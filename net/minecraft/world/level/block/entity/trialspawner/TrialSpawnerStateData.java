...
public class TrialSpawnerStateData {
    ...
    public void tryDetectPlayers(ServerLevel serverLevel, BlockPos blockPos, TrialSpawner trialSpawner) {
        ...
        if (trialSpawner.isOminous() || list2.isEmpty()) {
            ...
            Optional<Pair<Player, Holder<MobEffect>>> optional = TrialSpawnerStateData.findPlayerWithOminousEffect(serverLevel, list2);
        ...
        boolean bl4 = trialSpawner.getStateData().detectedPlayers.isEmpty();
    ...
    extends Record {
        ...
        public Packed(Set<UUID> set, Set<UUID> set2, long l, long l2, int n, Optional<SpawnData> optional, Optional<ResourceKey<LootTable>> optional2) {
