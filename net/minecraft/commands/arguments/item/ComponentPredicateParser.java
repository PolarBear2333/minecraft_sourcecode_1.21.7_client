        ...
        dictionary.putComplex(atom10, Term.alternative(Term.sequence(dictionary.named(atom11), StringReaderTerms.character('='), Term.cut(), dictionary.named(atom14)), Term.sequence(dictionary.named(atom12), StringReaderTerms.character('~'), Term.cut(), dictionary.named(atom14)), dictionary.named(atom11)), parseState -> {
            ...
            try {
                if (t != null) {
                    ...
                    return context.createPredicateTest((ImmutableStringReader)parseState.input(), t, dynamic);
                }
                Object t2 = scope.getOrThrow(atom11);
                Dynamic dynamic = (Dynamic)scope.get(atom14);
                return dynamic != null ? context.createComponentTest((ImmutableStringReader)parseState.input(), t2, dynamic) : context.createComponentTest((ImmutableStringReader)parseState.input(), t2);
            }
