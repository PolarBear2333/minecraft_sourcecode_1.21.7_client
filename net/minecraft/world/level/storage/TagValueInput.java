...
implements ValueInput {
    ...
    public <T> Optional<T> read(String string, Codec<T> codec) {
        ...
        return switch (SwitchBootstraps.typeSwitch("typeSwitch", new Object[]{DataResult.Success.class, DataResult.Error.class}, (Object)dataResult2, n)) {
            ...
            case 0 -> {
                DataResult.Success var6_6 = (DataResult.Success)dataResult2;
                yield Optional.of(var6_6.value());
            }
            case 1 -> {
                DataResult.Error var7_7 = (DataResult.Error)dataResult2;
                this.problemReporter.report(new DecodeFromFieldFailedProblem(string, tag, var7_7));
                yield var7_7.partialValue();
            }
        };
    }
    ...
    public <T> Optional<T> read(MapCodec<T> mapCodec) {
        ...
        return switch (SwitchBootstraps.typeSwitch("typeSwitch", new Object[]{DataResult.Success.class, DataResult.Error.class}, (Object)dataResult2, n)) {
            default -> throw new MatchException(null, null);
            case 0 -> {
                DataResult.Success var5_5 = (DataResult.Success)dataResult2;
                yield Optional.of(var5_5.value());
            }
            case 1 -> {
                DataResult.Error var6_6 = (DataResult.Error)dataResult2;
                this.problemReporter.report(new DecodeFromMapFailedProblem(var6_6));
                yield var6_6.partialValue();
            }
        };
    }
    ...
    @Override
    public byte getByteOr(String string, byte by) {
        NumericTag numericTag = this.getNumericTag(string);
        return numericTag != null ? numericTag.byteValue() : by;
    }
    ...
    @Override
    public int getIntOr(String string, int n) {
        NumericTag numericTag = this.getNumericTag(string);
        return numericTag != null ? numericTag.intValue() : n;
    }
    ...
    implements ValueInput.ValueInputList {
        ...
        ValueInput wrapChild(int n, CompoundTag compoundTag) {
            return TagValueInput.wrapChild(this.problemReporter.forChild(new ProblemReporter.IndexedPathElement(n)), this.context, compoundTag);
        }
            ...
            return new AbstractIterator<ValueInput>(){
                ...
                protected ValueInput computeNext() {
                    if (listIterator.hasNext()) {
                        ...
                        return this.wrapChild(n, compoundTag);
                    }
    ...
    implements ValueInput.ValueInputList {
        ...
        ProblemReporter reporterForChild(int n) {
            return this.problemReporter.forChild(new ProblemReporter.IndexedFieldPathElement(this.name, n));
        }

        void reportIndexUnwrapProblem(int n, Tag tag) {
            this.problemReporter.report(new UnexpectedListElementTypeProblem(this.name, n, CompoundTag.TYPE, tag.getType()));
        }
            ...
            return new AbstractIterator<ValueInput>(){
                ...
                protected ValueInput computeNext() {
                    while (iterator.hasNext()) {
                        ...
                        if (tag instanceof CompoundTag) {
                            CompoundTag compoundTag = (CompoundTag)tag;
                            return TagValueInput.wrapChild(this.reporterForChild(n), context, compoundTag);
                        }
                        this.reportIndexUnwrapProblem(n, tag);
                    }
                    return (ValueInput)this.endOfData();
                }
    ...
    implements ValueInput.TypedInputList<T> {
        ...
        void reportIndexUnwrapProblem(int n, Tag tag, DataResult.Error<?> error) {
            this.problemReporter.report(new DecodeFromListFailedProblem(this.name, n, tag, error));
        }
        ...
        public Stream<T> stream() {
            return Streams.mapWithIndex(this.list.stream(), (tag, l) -> {
                ...
                return switch (SwitchBootstraps.typeSwitch("typeSwitch", new Object[]{DataResult.Success.class, DataResult.Error.class}, (Object)dataResult2, n)) {
                    default -> throw new MatchException(null, null);
                    case 0 -> {
                        DataResult.Success var6_5 = (DataResult.Success)dataResult2;
                        yield var6_5.value();
                    }
                    case 1 -> {
                        DataResult.Error var7_6 = (DataResult.Error)dataResult2;
                        this.reportIndexUnwrapProblem((int)l, (Tag)tag, (DataResult.Error<?>)var7_6);
                        yield var7_6.partialValue().orElse(null);
                    }
                };
            }).filter(Objects::nonNull);
        }
            ...
            return new AbstractIterator<T>(){
                ...
                protected T computeNext() {
                    while (listIterator.hasNext()) {
                        ...
                        this.reportIndexUnwrapProblem(n, tag, error);
