...
extends Screen {
    ...
    public static boolean makeBackupAndShowToast(LevelStorageSource.LevelStorageAccess levelStorageAccess) {
        ...
        if (iOException != null) {
            MutableComponent mutableComponent = Component.translatable("selectWorld.edit.backupFailed");
            MutableComponent mutableComponent2 = Component.literal(iOException.getMessage());
            Minecraft.getInstance().getToastManager().addToast(new SystemToast(SystemToast.SystemToastId.WORLD_BACKUP, mutableComponent, mutableComponent2));
            return false;
        }
        MutableComponent mutableComponent = Component.translatable("selectWorld.edit.backupCreated", levelStorageAccess.getLevelId());
        MutableComponent mutableComponent3 = Component.translatable("selectWorld.edit.backupSize", Mth.ceil((double)l / 1048576.0));
        Minecraft.getInstance().getToastManager().addToast(new SystemToast(SystemToast.SystemToastId.WORLD_BACKUP, mutableComponent, mutableComponent3));
        return true;
    }
    ...
    private static /* synthetic */ void lambda$new$4(LevelStorageSource.LevelStorageAccess levelStorageAccess, Button button) {
