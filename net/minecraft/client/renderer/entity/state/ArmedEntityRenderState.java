...
extends LivingEntityRenderState {
    ...
    public static void extractArmedEntityRenderState(LivingEntity livingEntity, ArmedEntityRenderState armedEntityRenderState, ItemModelResolver itemModelResolver) {
        ...
        itemModelResolver.updateForLiving(armedEntityRenderState.rightHandItem, livingEntity.getItemHeldByArm(HumanoidArm.RIGHT), ItemDisplayContext.THIRD_PERSON_RIGHT_HAND, livingEntity);
        itemModelResolver.updateForLiving(armedEntityRenderState.leftHandItem, livingEntity.getItemHeldByArm(HumanoidArm.LEFT), ItemDisplayContext.THIRD_PERSON_LEFT_HAND, livingEntity);
    }
}
