...
extends SimpleCriterionTrigger<TriggerInstance> {
    ...
    public record TriggerInstance(Optional<ContextAwarePredicate> player, Optional<ItemPredicate> item) implements SimpleCriterionTrigger.SimpleInstance
    {
        ...
        public static Criterion<TriggerInstance> shotCrossbow(Optional<ItemPredicate> optional) {
            return CriteriaTriggers.SHOT_CROSSBOW.createCriterion(new TriggerInstance(Optional.empty(), optional));
        }

        public static Criterion<TriggerInstance> shotCrossbow(HolderGetter<Item> holderGetter, ItemLike itemLike) {
            return CriteriaTriggers.SHOT_CROSSBOW.createCriterion(new TriggerInstance(Optional.empty(), Optional.of(ItemPredicate.Builder.item().of(holderGetter, itemLike).build())));
        }
