...
public record ClientboundMapItemDataPacket(MapId mapId, byte scale, boolean locked, Optional<List<MapDecoration>> decorations, Optional<MapItemSavedData.MapPatch> colorPatch) implements Packet<ClientGamePacketListener>
{
    ...
    public ClientboundMapItemDataPacket(MapId mapId, byte by, boolean bl, @Nullable Collection<MapDecoration> collection, @Nullable MapItemSavedData.MapPatch mapPatch) {
        this(mapId, by, bl, collection != null ? Optional.of(List.copyOf(collection)) : Optional.empty(), Optional.ofNullable(mapPatch));
    }
