...
public class DataFixers {
    ...
    public static CompletableFuture<?> optimize(Set<DSL.TypeReference> set) {
        ...
        return DATA_FIXER.optimize(set, (Executor)executorService);
    }
    ...
    private static void addFixers(DataFixerBuilder dataFixerBuilder) {
        ...
        dataFixerBuilder.addFixer((DataFix)new RemoveBlockEntityTagFix(schema42, Set.of("minecraft:noteblock", "minecraft:flower_pot")));
        ...
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema135, "Rename copper item suffixes", DataFixers.createRenamer((Map<String, String>)immutableMap2)));
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema135, "Rename copper blocks suffixes", DataFixers.createRenamer((Map<String, String>)immutableMap2)));
        ...
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema137, "Renamed grimstone block items to deepslate", DataFixers.createRenamer((Map<String, String>)immutableMap3)));
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema137, "Renamed grimstone blocks to deepslate", DataFixers.createRenamer((Map<String, String>)immutableMap3)));
        ...
        dataFixerBuilder.addFixer((DataFix)new EntityVariantFix(schema164, "Change cat variant type", References.ENTITY, "minecraft:cat", "CatType", arg_0 -> ((Int2ObjectOpenHashMap)Util.make(new Int2ObjectOpenHashMap(), int2ObjectOpenHashMap -> {
        ...
        dataFixerBuilder.addFixer((DataFix)new CriteriaRenameFix(schema164, "Migrate cat variant advancement", "minecraft:husbandry/complete_catalogue", string -> (String)immutableMap4.getOrDefault(string, string)));
        Schema schema165 = dataFixerBuilder.addSchema(3087, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new EntityVariantFix(schema165, "Change frog variant type", References.ENTITY, "minecraft:frog", "Variant", arg_0 -> ((Int2ObjectOpenHashMap)Util.make(new Int2ObjectOpenHashMap(), int2ObjectOpenHashMap -> {
        ...
        dataFixerBuilder.addFixer((DataFix)new CriteriaRenameFix(schema169, "Migrate cat variant advancement for british shorthair", "minecraft:husbandry/complete_catalogue", string -> map.getOrDefault(string, (String)string)));
        dataFixerBuilder.addFixer((DataFix)new PoiTypeRemoveFix(schema169, "Remove unpopulated villager PoI types", Set.of("minecraft:unemployed", "minecraft:nitwit")::contains));
        ...
        UnaryOperator<String> unaryOperator2 = DataFixers.createRenamer(Map.of("minecraft:grass", "minecraft:short_grass"));
        dataFixerBuilder.addFixer(BlockRenameFix.create(schema201, "Rename grass block to short_grass", unaryOperator2));
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema201, "Rename grass item to short_grass", unaryOperator2));
        ...
        UnaryOperator<String> unaryOperator3 = DataFixers.createRenamer(Map.of("minecraft:scute", "minecraft:turtle_scute"));
        dataFixerBuilder.addFixer(ItemRenameFix.create(schema203, "Rename scute item to turtle_scute", unaryOperator3));
        ...
        Schema schema244 = dataFixerBuilder.addSchema(4180, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new FeatureFlagRemoveFix(schema244, "Remove Winter Drop toggle", Set.of("minecraft:winter_drop")));
        Schema schema245 = dataFixerBuilder.addSchema(4181, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new BlockEntityFurnaceBurnTimeFix(schema245, "minecraft:furnace"));
        dataFixerBuilder.addFixer((DataFix)new BlockEntityFurnaceBurnTimeFix(schema245, "minecraft:smoker"));
        dataFixerBuilder.addFixer((DataFix)new BlockEntityFurnaceBurnTimeFix(schema245, "minecraft:blast_furnace"));
        Schema schema246 = dataFixerBuilder.addSchema(4187, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new EntityAttributeBaseValueFix(schema246, "Villager follow range fix undo", "minecraft:villager", "minecraft:follow_range", d -> d == 48.0 ? 16.0 : d));
        dataFixerBuilder.addFixer((DataFix)new EntityAttributeBaseValueFix(schema246, "Bee follow range fix", "minecraft:bee", "minecraft:follow_range", d -> d == 48.0 ? 16.0 : d));
        dataFixerBuilder.addFixer((DataFix)new EntityAttributeBaseValueFix(schema246, "Allay follow range fix", "minecraft:allay", "minecraft:follow_range", d -> d == 48.0 ? 16.0 : d));
        dataFixerBuilder.addFixer((DataFix)new EntityAttributeBaseValueFix(schema246, "Llama follow range fix", "minecraft:llama", "minecraft:follow_range", d -> d == 40.0 ? 16.0 : d));
        dataFixerBuilder.addFixer((DataFix)new EntityAttributeBaseValueFix(schema246, "Piglin Brute follow range fix", "minecraft:piglin_brute", "minecraft:follow_range", d -> d == 16.0 ? 12.0 : d));
        dataFixerBuilder.addFixer((DataFix)new EntityAttributeBaseValueFix(schema246, "Warden follow range fix", "minecraft:warden", "minecraft:follow_range", d -> d == 16.0 ? 24.0 : d));
        Schema schema247 = dataFixerBuilder.addSchema(4290, V4290::new);
        dataFixerBuilder.addFixer((DataFix)new UnflattenTextComponentFix(schema247));
        Schema schema248 = dataFixerBuilder.addSchema(4291, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new LegacyHoverEventFix(schema248));
        dataFixerBuilder.addFixer((DataFix)new TextComponentStringifiedFlagsFix(schema248));
        Schema schema249 = dataFixerBuilder.addSchema(4292, V4292::new);
        dataFixerBuilder.addFixer((DataFix)new TextComponentHoverAndClickEventFix(schema249));
        Schema schema250 = dataFixerBuilder.addSchema(4293, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new DropChancesFormatFix(schema250));
        Schema schema251 = dataFixerBuilder.addSchema(4294, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new BlockPropertyRenameAndFix(schema251, "CreakingHeartBlockStateFix", "minecraft:creaking_heart", "active", "creaking_heart_state", string -> string.equals("true") ? "awake" : "uprooted"));
        Schema schema252 = dataFixerBuilder.addSchema(4295, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new BlendingDataFix(schema252));
        Schema schema253 = dataFixerBuilder.addSchema(4296, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new AreaEffectCloudDurationScaleFix(schema253));
        Schema schema254 = dataFixerBuilder.addSchema(4297, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new ForcedChunkToTicketFix(schema254));
        Schema schema255 = dataFixerBuilder.addSchema(4299, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new EntitySpawnerItemVariantComponentFix(schema255));
        Schema schema256 = dataFixerBuilder.addSchema(4300, V4300::new);
        dataFixerBuilder.addFixer((DataFix)new SaddleEquipmentSlotFix(schema256));
        Schema schema257 = dataFixerBuilder.addSchema(4301, V4301::new);
        dataFixerBuilder.addFixer((DataFix)new EquipmentFormatFix(schema257));
        Schema schema258 = dataFixerBuilder.addSchema(4302, V4302::new);
        dataFixerBuilder.addFixer((DataFix)new AddNewChoices(schema258, "Added Test and Test Instance Block Entities", References.BLOCK_ENTITY));
        Schema schema259 = dataFixerBuilder.addSchema(4303, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new EntityFallDistanceFloatToDoubleFix(schema259, References.ENTITY));
        dataFixerBuilder.addFixer((DataFix)new EntityFallDistanceFloatToDoubleFix(schema259, References.PLAYER));
        Schema schema260 = dataFixerBuilder.addSchema(4305, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new BlockPropertyRenameAndFix(schema260, "rename test block mode", "minecraft:test_block", "test_block_mode", "mode", string -> string));
        Schema schema261 = dataFixerBuilder.addSchema(4306, V4306::new);
        dataFixerBuilder.addFixer((DataFix)new ThrownPotionSplitFix(schema261));
        Schema schema262 = dataFixerBuilder.addSchema(4307, V4307::new);
        dataFixerBuilder.addFixer((DataFix)new TooltipDisplayComponentFix(schema262));
        Schema schema263 = dataFixerBuilder.addSchema(4309, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new RaidRenamesDataFix(schema263));
        dataFixerBuilder.addFixer((DataFix)new ChunkTicketUnpackPosFix(schema263));
        Schema schema264 = dataFixerBuilder.addSchema(4311, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new AdvancementsRenameFix(schema264, false, "Use lodestone category change", DataFixers.createRenamer("minecraft:nether/use_lodestone", "minecraft:adventure/use_lodestone")));
        Schema schema265 = dataFixerBuilder.addSchema(4312, V4312::new);
        dataFixerBuilder.addFixer((DataFix)new PlayerEquipmentFix(schema265));
        Schema schema266 = dataFixerBuilder.addSchema(4314, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new InlineBlockPosFormatFix(schema266));
        Schema schema267 = dataFixerBuilder.addSchema(4420, V4420::new);
        dataFixerBuilder.addFixer((DataFix)new NamedEntityConvertUncheckedFix(schema267, "AreaEffectCloudCustomParticleFix", References.ENTITY, "minecraft:area_effect_cloud"));
        Schema schema268 = dataFixerBuilder.addSchema(4421, V4421::new);
        dataFixerBuilder.addFixer((DataFix)new AddNewChoices(schema268, "Added Happy Ghast", References.ENTITY));
        Schema schema269 = dataFixerBuilder.addSchema(4424, SAME_NAMESPACED);
        dataFixerBuilder.addFixer((DataFix)new FeatureFlagRemoveFix(schema269, "Remove Locator Bar experimental feature flag", Set.of("minecraft:locator_bar")));
    }
