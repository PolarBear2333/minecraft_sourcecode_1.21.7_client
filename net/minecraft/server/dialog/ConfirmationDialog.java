...
{
    public static final MapCodec<ConfirmationDialog> MAP_CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group((App)CommonDialogData.MAP_CODEC.forGetter(ConfirmationDialog::common), (App)ActionButton.CODEC.fieldOf("yes").forGetter(ConfirmationDialog::yesButton), (App)ActionButton.CODEC.fieldOf("no").forGetter(ConfirmationDialog::noButton)).apply((Applicative)instance, ConfirmationDialog::new));
