...
public record ServerboundCustomClickActionPacket(ResourceLocation id, Optional<Tag> payload) implements Packet<ServerCommonPacketListener>
{
    ...
    public static final StreamCodec<ByteBuf, ServerboundCustomClickActionPacket> STREAM_CODEC = StreamCodec.composite(ResourceLocation.STREAM_CODEC, ServerboundCustomClickActionPacket::id, UNTRUSTED_TAG_CODEC, ServerboundCustomClickActionPacket::payload, ServerboundCustomClickActionPacket::new);
