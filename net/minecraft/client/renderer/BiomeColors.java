...
public class BiomeColors {
    ...
    public static final ColorResolver DRY_FOLIAGE_COLOR_RESOLVER = (biome, d, d2) -> biome.getDryFoliageColor();
    ...
    public static int getAverageDryFoliageColor(BlockAndTintGetter blockAndTintGetter, BlockPos blockPos) {
        return BiomeColors.getAverageColor(blockAndTintGetter, blockPos, DRY_FOLIAGE_COLOR_RESOLVER);
    }
