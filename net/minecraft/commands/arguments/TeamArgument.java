...
implements ArgumentType<String> {
    ...
    private static final DynamicCommandExceptionType ERROR_TEAM_NOT_FOUND = new DynamicCommandExceptionType(object -> Component.translatableEscape("team.notFound", object));
