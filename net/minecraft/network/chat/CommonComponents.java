...
public class CommonComponents {
    ...
    public static Component disconnectButtonLabel(boolean bl) {
        return bl ? GUI_RETURN_TO_MENU : GUI_DISCONNECT;
    }
    ...
    public static MutableComponent joinForNarration(Component ... componentArray) {
        MutableComponent mutableComponent = Component.empty();
        for (int i = 0; i < componentArray.length; ++i) {
            mutableComponent.append(componentArray[i]);
    ...
    public static Component joinLines(Component ... componentArray) {
        return CommonComponents.joinLines(Arrays.asList(componentArray));
    }
