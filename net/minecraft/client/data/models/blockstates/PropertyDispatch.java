...
public abstract class PropertyDispatch<V> {
    ...
    protected void putValue(PropertyValueList propertyValueList, V v) {
        V v2 = this.values.put(propertyValueList, v);
        if (v2 != null) {
            throw new IllegalStateException("Value " + String.valueOf(propertyValueList) + " is already defined");
        }
    }
    ...
    extends PropertyDispatch<V> {
        ...
        public C1<V, T1> select(T1 T1, V v) {
            PropertyValueList propertyValueList = PropertyValueList.of(this.property1.value(T1));
            this.putValue(propertyValueList, v);
            return this;
        }
    ...
    extends PropertyDispatch<V> {
        ...
        public C2<V, T1, T2> select(T1 T1, T2 T2, V v) {
            PropertyValueList propertyValueList = PropertyValueList.of(this.property1.value(T1), this.property2.value(T2));
            this.putValue(propertyValueList, v);
            return this;
        }
    ...
    extends PropertyDispatch<V> {
        ...
        public C3<V, T1, T2, T3> select(T1 T1, T2 T2, T3 T3, V v) {
            PropertyValueList propertyValueList = PropertyValueList.of(this.property1.value(T1), this.property2.value(T2), this.property3.value(T3));
            this.putValue(propertyValueList, v);
            return this;
        }
    ...
    extends PropertyDispatch<V> {
        ...
        public C4<V, T1, T2, T3, T4> select(T1 T1, T2 T2, T3 T3, T4 T4, V v) {
            PropertyValueList propertyValueList = PropertyValueList.of(this.property1.value(T1), this.property2.value(T2), this.property3.value(T3), this.property4.value(T4));
            this.putValue(propertyValueList, v);
            return this;
        }
    ...
    extends PropertyDispatch<V> {
        ...
        public C5<V, T1, T2, T3, T4, T5> select(T1 T1, T2 T2, T3 T3, T4 T4, T5 T5, V v) {
            PropertyValueList propertyValueList = PropertyValueList.of(this.property1.value(T1), this.property2.value(T2), this.property3.value(T3), this.property4.value(T4), this.property5.value(T5));
            this.putValue(propertyValueList, v);
            return this;
        }
