...
public interface RealmsError {
    ...
    public record CustomError(int httpCode, @Nullable Component payload) implements RealmsError
    {
        ...
        public static CustomError htmlPayload(int n, String string) {
            int n2 = string.indexOf(BODY_TAG);
            int n3 = string.indexOf(CLOSING_BODY_TAG);
            if (n2 >= 0 && n3 > n2) {
                return new CustomError(n, Component.literal(string.substring(n2 + BODY_TAG.length(), n3).trim()));
            }
