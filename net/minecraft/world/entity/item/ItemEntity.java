...
implements TraceableEntity {
    ...
    public ItemEntity(Level level, double d, double d2, double d3, ItemStack itemStack) {
        this(level, d, d2, d3, itemStack, level.random.nextDouble() * 0.2 - 0.1, 0.2, level.random.nextDouble() * 0.2 - 0.1);
    }
    ...
    public void tick() {
        ...
        int n2 = n = bl ? 2 : 40;
        if (this.tickCount % n == 0 && !this.level().isClientSide && this.isMergable()) {
    ...
    public static ItemStack merge(ItemStack itemStack, ItemStack itemStack2, int n) {
        ...
        ItemStack itemStack3 = itemStack.copyWithCount(itemStack.getCount() + n2);
