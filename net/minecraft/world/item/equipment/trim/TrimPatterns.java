...
public class TrimPatterns {
    ...
    public static void register(BootstrapContext<TrimPattern> bootstrapContext, ResourceKey<TrimPattern> resourceKey) {
        TrimPattern trimPattern = new TrimPattern(TrimPatterns.defaultAssetId(resourceKey), Component.translatable(Util.makeDescriptionId("trim_pattern", resourceKey.location())), false);
