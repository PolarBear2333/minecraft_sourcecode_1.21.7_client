...
public record DebugStickState(Map<Holder<Block>, Property<?>> properties) {
    ...
    public static final Codec<DebugStickState> CODEC = Codec.dispatchedMap(BuiltInRegistries.BLOCK.holderByNameCodec(), holder -> Codec.STRING.comapFlatMap(string -> {
        Property<?> property = ((Block)holder.value()).getStateDefinition().getProperty((String)string);
