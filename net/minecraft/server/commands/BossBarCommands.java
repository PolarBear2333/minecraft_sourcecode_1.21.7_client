...
public class BossBarCommands {
    private static final DynamicCommandExceptionType ERROR_ALREADY_EXISTS = new DynamicCommandExceptionType(object -> Component.translatableEscape("commands.bossbar.create.failed", object));
    private static final DynamicCommandExceptionType ERROR_DOESNT_EXIST = new DynamicCommandExceptionType(object -> Component.translatableEscape("commands.bossbar.unknown", object));
    ...
    private static int setValue(CommandSourceStack commandSourceStack, CustomBossEvent customBossEvent, int n) throws CommandSyntaxException {
        ...
        commandSourceStack.sendSuccess(() -> Component.translatable("commands.bossbar.set.value.success", customBossEvent.getDisplayName(), n), true);
        return n;
    }
    ...
    private static int setMax(CommandSourceStack commandSourceStack, CustomBossEvent customBossEvent, int n) throws CommandSyntaxException {
        ...
        commandSourceStack.sendSuccess(() -> Component.translatable("commands.bossbar.set.max.success", customBossEvent.getDisplayName(), n), true);
        return n;
    }
