...
extends Monster {
                    ...
                    while (n2 <= 10 && n2 >= -10) {
                        ...
                        while (n3 <= 10 && n3 >= -10) {
                            ...
                            if (block instanceof InfestedBlock) {
                                if (SilverfishWakeUpFriendsGoal.getServerLevel(level).getGameRules().getBoolean(GameRules.RULE_MOBGRIEFING)) {
    ...
    extends RandomStrollGoal {
        ...
        public boolean canUse() {
            ...
            if (SilverfishMergeWithStoneGoal.getServerLevel(this.mob).getGameRules().getBoolean(GameRules.RULE_MOBGRIEFING) && randomSource.nextInt(SilverfishMergeWithStoneGoal.reducedTickDelay(10)) == 0) {
        ...
        public void start() {
            ...
            BlockState blockState = level.getBlockState(blockPos = BlockPos.containing(this.mob.getX(), this.mob.getY() + 0.5, this.mob.getZ()).relative(this.selectedDirection));
            if (InfestedBlock.isCompatibleHostBlock(blockState)) {
