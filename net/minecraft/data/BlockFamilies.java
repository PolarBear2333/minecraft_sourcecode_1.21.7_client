...
public class BlockFamilies {
    ...
    public static final BlockFamily BAMBOO_PLANKS = BlockFamilies.familyBuilder(Blocks.BAMBOO_PLANKS).button(Blocks.BAMBOO_BUTTON).slab(Blocks.BAMBOO_SLAB).stairs(Blocks.BAMBOO_STAIRS).customFence(Blocks.BAMBOO_FENCE).customFenceGate(Blocks.BAMBOO_FENCE_GATE).pressurePlate(Blocks.BAMBOO_PRESSURE_PLATE).sign(Blocks.BAMBOO_SIGN, Blocks.BAMBOO_WALL_SIGN).door(Blocks.BAMBOO_DOOR).trapdoor(Blocks.BAMBOO_TRAPDOOR).mosaic(Blocks.BAMBOO_MOSAIC).recipeGroupPrefix("wooden").recipeUnlockedBy("has_planks").getFamily();
    public static final BlockFamily BAMBOO_MOSAIC = BlockFamilies.familyBuilder(Blocks.BAMBOO_MOSAIC).slab(Blocks.BAMBOO_MOSAIC_SLAB).stairs(Blocks.BAMBOO_MOSAIC_STAIRS).getFamily();
    ...
    public static final BlockFamily CUT_COPPER = BlockFamilies.familyBuilder(Blocks.CUT_COPPER).slab(Blocks.CUT_COPPER_SLAB).stairs(Blocks.CUT_COPPER_STAIRS).chiseled(Blocks.CHISELED_COPPER).dontGenerateModel().getFamily();
    ...
    public static final BlockFamily WAXED_CUT_COPPER = BlockFamilies.familyBuilder(Blocks.WAXED_CUT_COPPER).slab(Blocks.WAXED_CUT_COPPER_SLAB).stairs(Blocks.WAXED_CUT_COPPER_STAIRS).chiseled(Blocks.WAXED_CHISELED_COPPER).recipeGroupPrefix("waxed_cut_copper").dontGenerateModel().getFamily();
    ...
    public static final BlockFamily EXPOSED_CUT_COPPER = BlockFamilies.familyBuilder(Blocks.EXPOSED_CUT_COPPER).slab(Blocks.EXPOSED_CUT_COPPER_SLAB).stairs(Blocks.EXPOSED_CUT_COPPER_STAIRS).chiseled(Blocks.EXPOSED_CHISELED_COPPER).dontGenerateModel().getFamily();
    ...
    public static final BlockFamily WAXED_EXPOSED_CUT_COPPER = BlockFamilies.familyBuilder(Blocks.WAXED_EXPOSED_CUT_COPPER).slab(Blocks.WAXED_EXPOSED_CUT_COPPER_SLAB).stairs(Blocks.WAXED_EXPOSED_CUT_COPPER_STAIRS).chiseled(Blocks.WAXED_EXPOSED_CHISELED_COPPER).recipeGroupPrefix("waxed_exposed_cut_copper").dontGenerateModel().getFamily();
    ...
    public static final BlockFamily WEATHERED_CUT_COPPER = BlockFamilies.familyBuilder(Blocks.WEATHERED_CUT_COPPER).slab(Blocks.WEATHERED_CUT_COPPER_SLAB).stairs(Blocks.WEATHERED_CUT_COPPER_STAIRS).chiseled(Blocks.WEATHERED_CHISELED_COPPER).dontGenerateModel().getFamily();
    ...
    public static final BlockFamily WAXED_WEATHERED_CUT_COPPER = BlockFamilies.familyBuilder(Blocks.WAXED_WEATHERED_CUT_COPPER).slab(Blocks.WAXED_WEATHERED_CUT_COPPER_SLAB).stairs(Blocks.WAXED_WEATHERED_CUT_COPPER_STAIRS).chiseled(Blocks.WAXED_WEATHERED_CHISELED_COPPER).recipeGroupPrefix("waxed_weathered_cut_copper").dontGenerateModel().getFamily();
    ...
    public static final BlockFamily OXIDIZED_CUT_COPPER = BlockFamilies.familyBuilder(Blocks.OXIDIZED_CUT_COPPER).slab(Blocks.OXIDIZED_CUT_COPPER_SLAB).stairs(Blocks.OXIDIZED_CUT_COPPER_STAIRS).chiseled(Blocks.OXIDIZED_CHISELED_COPPER).dontGenerateModel().getFamily();
    ...
    public static final BlockFamily WAXED_OXIDIZED_CUT_COPPER = BlockFamilies.familyBuilder(Blocks.WAXED_OXIDIZED_CUT_COPPER).slab(Blocks.WAXED_OXIDIZED_CUT_COPPER_SLAB).stairs(Blocks.WAXED_OXIDIZED_CUT_COPPER_STAIRS).chiseled(Blocks.WAXED_OXIDIZED_CHISELED_COPPER).recipeGroupPrefix("waxed_oxidized_cut_copper").dontGenerateModel().getFamily();
    ...
    public static final BlockFamily TUFF = BlockFamilies.familyBuilder(Blocks.TUFF).wall(Blocks.TUFF_WALL).stairs(Blocks.TUFF_STAIRS).slab(Blocks.TUFF_SLAB).chiseled(Blocks.CHISELED_TUFF).polished(Blocks.POLISHED_TUFF).getFamily();
    public static final BlockFamily POLISHED_TUFF = BlockFamilies.familyBuilder(Blocks.POLISHED_TUFF).wall(Blocks.POLISHED_TUFF_WALL).stairs(Blocks.POLISHED_TUFF_STAIRS).slab(Blocks.POLISHED_TUFF_SLAB).polished(Blocks.TUFF_BRICKS).getFamily();
    public static final BlockFamily TUFF_BRICKS = BlockFamilies.familyBuilder(Blocks.TUFF_BRICKS).wall(Blocks.TUFF_BRICK_WALL).stairs(Blocks.TUFF_BRICK_STAIRS).slab(Blocks.TUFF_BRICK_SLAB).chiseled(Blocks.CHISELED_TUFF_BRICKS).getFamily();
    public static final BlockFamily RESIN_BRICKS = BlockFamilies.familyBuilder(Blocks.RESIN_BRICKS).wall(Blocks.RESIN_BRICK_WALL).stairs(Blocks.RESIN_BRICK_STAIRS).slab(Blocks.RESIN_BRICK_SLAB).chiseled(Blocks.CHISELED_RESIN_BRICKS).getFamily();
