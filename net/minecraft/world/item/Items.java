...
public class Items {
    ...
    public static final Item CHISELED_BOOKSHELF = Items.registerBlock(Blocks.CHISELED_BOOKSHELF, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    ...
    public static final Item TORCH = Items.registerBlock(Blocks.TORCH, (Block block, Item.Properties properties) -> new StandingAndWallBlockItem((Block)block, Blocks.WALL_TORCH, Direction.DOWN, (Item.Properties)properties));
    ...
    public static final Item CHEST = Items.registerBlock(Blocks.CHEST, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    ...
    public static final Item FURNACE = Items.registerBlock(Blocks.FURNACE, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    ...
    public static final Item CARVED_PUMPKIN = Items.registerBlock(Blocks.CARVED_PUMPKIN, properties -> Waypoint.addHideAttribute(properties).component(DataComponents.EQUIPPABLE, Equippable.builder(EquipmentSlot.HEAD).setSwappable(false).setCameraOverlay(ResourceLocation.withDefaultNamespace("misc/pumpkinblur")).build()));
    ...
    public static final Item SOUL_TORCH = Items.registerBlock(Blocks.SOUL_TORCH, (Block block, Item.Properties properties) -> new StandingAndWallBlockItem((Block)block, Blocks.SOUL_WALL_TORCH, Direction.DOWN, (Item.Properties)properties));
    ...
    public static final Item LIGHT = Items.registerBlock(Blocks.LIGHT, properties -> properties.rarity(Rarity.EPIC).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(LightBlock.LEVEL, 15)));
    public static final Item HAY_BLOCK = Items.registerBlock(Blocks.HAY_BLOCK);
    public static final Item WHITE_CARPET = Items.registerBlock(Blocks.WHITE_CARPET, properties -> properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.WHITE)));
    public static final Item ORANGE_CARPET = Items.registerBlock(Blocks.ORANGE_CARPET, properties -> properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.ORANGE)));
    public static final Item MAGENTA_CARPET = Items.registerBlock(Blocks.MAGENTA_CARPET, properties -> properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.MAGENTA)));
    public static final Item LIGHT_BLUE_CARPET = Items.registerBlock(Blocks.LIGHT_BLUE_CARPET, properties -> properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.LIGHT_BLUE)));
    public static final Item YELLOW_CARPET = Items.registerBlock(Blocks.YELLOW_CARPET, properties -> properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.YELLOW)));
    public static final Item LIME_CARPET = Items.registerBlock(Blocks.LIME_CARPET, properties -> properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.LIME)));
    public static final Item PINK_CARPET = Items.registerBlock(Blocks.PINK_CARPET, properties -> properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.PINK)));
    public static final Item GRAY_CARPET = Items.registerBlock(Blocks.GRAY_CARPET, properties -> properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.GRAY)));
    public static final Item LIGHT_GRAY_CARPET = Items.registerBlock(Blocks.LIGHT_GRAY_CARPET, properties -> properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.LIGHT_GRAY)));
    public static final Item CYAN_CARPET = Items.registerBlock(Blocks.CYAN_CARPET, properties -> properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.CYAN)));
    public static final Item PURPLE_CARPET = Items.registerBlock(Blocks.PURPLE_CARPET, properties -> properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.PURPLE)));
    public static final Item BLUE_CARPET = Items.registerBlock(Blocks.BLUE_CARPET, properties -> properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.BLUE)));
    public static final Item BROWN_CARPET = Items.registerBlock(Blocks.BROWN_CARPET, properties -> properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.BROWN)));
    public static final Item GREEN_CARPET = Items.registerBlock(Blocks.GREEN_CARPET, properties -> properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.GREEN)));
    public static final Item RED_CARPET = Items.registerBlock(Blocks.RED_CARPET, properties -> properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.RED)));
    public static final Item BLACK_CARPET = Items.registerBlock(Blocks.BLACK_CARPET, properties -> properties.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.BLACK)));
    ...
    public static final Item SNIFFER_EGG = Items.registerBlock(Blocks.SNIFFER_EGG, properties -> properties.rarity(Rarity.UNCOMMON));
    ...
    public static final Item TUBE_CORAL_FAN = Items.registerBlock(Blocks.TUBE_CORAL_FAN, (Block block, Item.Properties properties) -> new StandingAndWallBlockItem((Block)block, Blocks.TUBE_CORAL_WALL_FAN, Direction.DOWN, (Item.Properties)properties));
    public static final Item BRAIN_CORAL_FAN = Items.registerBlock(Blocks.BRAIN_CORAL_FAN, (Block block, Item.Properties properties) -> new StandingAndWallBlockItem((Block)block, Blocks.BRAIN_CORAL_WALL_FAN, Direction.DOWN, (Item.Properties)properties));
    public static final Item BUBBLE_CORAL_FAN = Items.registerBlock(Blocks.BUBBLE_CORAL_FAN, (Block block, Item.Properties properties) -> new StandingAndWallBlockItem((Block)block, Blocks.BUBBLE_CORAL_WALL_FAN, Direction.DOWN, (Item.Properties)properties));
    public static final Item FIRE_CORAL_FAN = Items.registerBlock(Blocks.FIRE_CORAL_FAN, (Block block, Item.Properties properties) -> new StandingAndWallBlockItem((Block)block, Blocks.FIRE_CORAL_WALL_FAN, Direction.DOWN, (Item.Properties)properties));
    public static final Item HORN_CORAL_FAN = Items.registerBlock(Blocks.HORN_CORAL_FAN, (Block block, Item.Properties properties) -> new StandingAndWallBlockItem((Block)block, Blocks.HORN_CORAL_WALL_FAN, Direction.DOWN, (Item.Properties)properties));
    public static final Item DEAD_TUBE_CORAL_FAN = Items.registerBlock(Blocks.DEAD_TUBE_CORAL_FAN, (Block block, Item.Properties properties) -> new StandingAndWallBlockItem((Block)block, Blocks.DEAD_TUBE_CORAL_WALL_FAN, Direction.DOWN, (Item.Properties)properties));
    public static final Item DEAD_BRAIN_CORAL_FAN = Items.registerBlock(Blocks.DEAD_BRAIN_CORAL_FAN, (Block block, Item.Properties properties) -> new StandingAndWallBlockItem((Block)block, Blocks.DEAD_BRAIN_CORAL_WALL_FAN, Direction.DOWN, (Item.Properties)properties));
    public static final Item DEAD_BUBBLE_CORAL_FAN = Items.registerBlock(Blocks.DEAD_BUBBLE_CORAL_FAN, (Block block, Item.Properties properties) -> new StandingAndWallBlockItem((Block)block, Blocks.DEAD_BUBBLE_CORAL_WALL_FAN, Direction.DOWN, (Item.Properties)properties));
    public static final Item DEAD_FIRE_CORAL_FAN = Items.registerBlock(Blocks.DEAD_FIRE_CORAL_FAN, (Block block, Item.Properties properties) -> new StandingAndWallBlockItem((Block)block, Blocks.DEAD_FIRE_CORAL_WALL_FAN, Direction.DOWN, (Item.Properties)properties));
    public static final Item DEAD_HORN_CORAL_FAN = Items.registerBlock(Blocks.DEAD_HORN_CORAL_FAN, (Block block, Item.Properties properties) -> new StandingAndWallBlockItem((Block)block, Blocks.DEAD_HORN_CORAL_WALL_FAN, Direction.DOWN, (Item.Properties)properties));
    ...
    public static final Item REDSTONE_TORCH = Items.registerBlock(Blocks.REDSTONE_TORCH, (Block block, Item.Properties properties) -> new StandingAndWallBlockItem((Block)block, Blocks.REDSTONE_WALL_TORCH, Direction.DOWN, (Item.Properties)properties));
    ...
    public static final Item HOPPER = Items.registerBlock(Blocks.HOPPER, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item DISPENSER = Items.registerBlock(Blocks.DISPENSER, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item DROPPER = Items.registerBlock(Blocks.DROPPER, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    ...
    public static final Item TRAPPED_CHEST = Items.registerBlock(Blocks.TRAPPED_CHEST, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    ...
    public static final Item MINECART = Items.registerItem("minecart", (Item.Properties properties) -> new MinecartItem((EntityType<? extends AbstractMinecart>)EntityType.MINECART, (Item.Properties)properties), new Item.Properties().stacksTo(1));
    public static final Item CHEST_MINECART = Items.registerItem("chest_minecart", (Item.Properties properties) -> new MinecartItem((EntityType<? extends AbstractMinecart>)EntityType.CHEST_MINECART, (Item.Properties)properties), new Item.Properties().stacksTo(1));
    public static final Item FURNACE_MINECART = Items.registerItem("furnace_minecart", (Item.Properties properties) -> new MinecartItem((EntityType<? extends AbstractMinecart>)EntityType.FURNACE_MINECART, (Item.Properties)properties), new Item.Properties().stacksTo(1));
    public static final Item TNT_MINECART = Items.registerItem("tnt_minecart", (Item.Properties properties) -> new MinecartItem((EntityType<? extends AbstractMinecart>)EntityType.TNT_MINECART, (Item.Properties)properties), new Item.Properties().stacksTo(1));
    public static final Item HOPPER_MINECART = Items.registerItem("hopper_minecart", (Item.Properties properties) -> new MinecartItem((EntityType<? extends AbstractMinecart>)EntityType.HOPPER_MINECART, (Item.Properties)properties), new Item.Properties().stacksTo(1));
    public static final Item CARROT_ON_A_STICK = Items.registerItem("carrot_on_a_stick", (Item.Properties properties) -> new FoodOnAStickItem<Pig>(EntityType.PIG, 7, (Item.Properties)properties), new Item.Properties().durability(25));
    public static final Item WARPED_FUNGUS_ON_A_STICK = Items.registerItem("warped_fungus_on_a_stick", (Item.Properties properties) -> new FoodOnAStickItem<Strider>(EntityType.STRIDER, 1, (Item.Properties)properties), new Item.Properties().durability(100));
    ...
    public static final Item OAK_BOAT = Items.registerItem("oak_boat", (Item.Properties properties) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.OAK_BOAT, (Item.Properties)properties), new Item.Properties().stacksTo(1));
    public static final Item OAK_CHEST_BOAT = Items.registerItem("oak_chest_boat", (Item.Properties properties) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.OAK_CHEST_BOAT, (Item.Properties)properties), new Item.Properties().stacksTo(1));
    public static final Item SPRUCE_BOAT = Items.registerItem("spruce_boat", (Item.Properties properties) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.SPRUCE_BOAT, (Item.Properties)properties), new Item.Properties().stacksTo(1));
    public static final Item SPRUCE_CHEST_BOAT = Items.registerItem("spruce_chest_boat", (Item.Properties properties) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.SPRUCE_CHEST_BOAT, (Item.Properties)properties), new Item.Properties().stacksTo(1));
    public static final Item BIRCH_BOAT = Items.registerItem("birch_boat", (Item.Properties properties) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.BIRCH_BOAT, (Item.Properties)properties), new Item.Properties().stacksTo(1));
    public static final Item BIRCH_CHEST_BOAT = Items.registerItem("birch_chest_boat", (Item.Properties properties) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.BIRCH_CHEST_BOAT, (Item.Properties)properties), new Item.Properties().stacksTo(1));
    public static final Item JUNGLE_BOAT = Items.registerItem("jungle_boat", (Item.Properties properties) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.JUNGLE_BOAT, (Item.Properties)properties), new Item.Properties().stacksTo(1));
    public static final Item JUNGLE_CHEST_BOAT = Items.registerItem("jungle_chest_boat", (Item.Properties properties) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.JUNGLE_CHEST_BOAT, (Item.Properties)properties), new Item.Properties().stacksTo(1));
    public static final Item ACACIA_BOAT = Items.registerItem("acacia_boat", (Item.Properties properties) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.ACACIA_BOAT, (Item.Properties)properties), new Item.Properties().stacksTo(1));
    public static final Item ACACIA_CHEST_BOAT = Items.registerItem("acacia_chest_boat", (Item.Properties properties) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.ACACIA_CHEST_BOAT, (Item.Properties)properties), new Item.Properties().stacksTo(1));
    public static final Item CHERRY_BOAT = Items.registerItem("cherry_boat", (Item.Properties properties) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.CHERRY_BOAT, (Item.Properties)properties), new Item.Properties().stacksTo(1));
    public static final Item CHERRY_CHEST_BOAT = Items.registerItem("cherry_chest_boat", (Item.Properties properties) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.CHERRY_CHEST_BOAT, (Item.Properties)properties), new Item.Properties().stacksTo(1));
    public static final Item DARK_OAK_BOAT = Items.registerItem("dark_oak_boat", (Item.Properties properties) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.DARK_OAK_BOAT, (Item.Properties)properties), new Item.Properties().stacksTo(1));
    public static final Item DARK_OAK_CHEST_BOAT = Items.registerItem("dark_oak_chest_boat", (Item.Properties properties) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.DARK_OAK_CHEST_BOAT, (Item.Properties)properties), new Item.Properties().stacksTo(1));
    public static final Item PALE_OAK_BOAT = Items.registerItem("pale_oak_boat", (Item.Properties properties) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.PALE_OAK_BOAT, (Item.Properties)properties), new Item.Properties().stacksTo(1));
    public static final Item PALE_OAK_CHEST_BOAT = Items.registerItem("pale_oak_chest_boat", (Item.Properties properties) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.PALE_OAK_CHEST_BOAT, (Item.Properties)properties), new Item.Properties().stacksTo(1));
    public static final Item MANGROVE_BOAT = Items.registerItem("mangrove_boat", (Item.Properties properties) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.MANGROVE_BOAT, (Item.Properties)properties), new Item.Properties().stacksTo(1));
    public static final Item MANGROVE_CHEST_BOAT = Items.registerItem("mangrove_chest_boat", (Item.Properties properties) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.MANGROVE_CHEST_BOAT, (Item.Properties)properties), new Item.Properties().stacksTo(1));
    public static final Item BAMBOO_RAFT = Items.registerItem("bamboo_raft", (Item.Properties properties) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.BAMBOO_RAFT, (Item.Properties)properties), new Item.Properties().stacksTo(1));
    public static final Item BAMBOO_CHEST_RAFT = Items.registerItem("bamboo_chest_raft", (Item.Properties properties) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.BAMBOO_CHEST_RAFT, (Item.Properties)properties), new Item.Properties().stacksTo(1));
    ...
    public static final Item WOODEN_SHOVEL = Items.registerItem("wooden_shovel", (Item.Properties properties) -> new ShovelItem(ToolMaterial.WOOD, 1.5f, -3.0f, (Item.Properties)properties));
    ...
    public static final Item WOODEN_AXE = Items.registerItem("wooden_axe", (Item.Properties properties) -> new AxeItem(ToolMaterial.WOOD, 6.0f, -3.2f, (Item.Properties)properties));
    public static final Item WOODEN_HOE = Items.registerItem("wooden_hoe", (Item.Properties properties) -> new HoeItem(ToolMaterial.WOOD, 0.0f, -3.0f, (Item.Properties)properties));
    ...
    public static final Item STONE_SHOVEL = Items.registerItem("stone_shovel", (Item.Properties properties) -> new ShovelItem(ToolMaterial.STONE, 1.5f, -3.0f, (Item.Properties)properties));
    ...
    public static final Item STONE_AXE = Items.registerItem("stone_axe", (Item.Properties properties) -> new AxeItem(ToolMaterial.STONE, 7.0f, -3.2f, (Item.Properties)properties));
    public static final Item STONE_HOE = Items.registerItem("stone_hoe", (Item.Properties properties) -> new HoeItem(ToolMaterial.STONE, -1.0f, -2.0f, (Item.Properties)properties));
    ...
    public static final Item GOLDEN_SHOVEL = Items.registerItem("golden_shovel", (Item.Properties properties) -> new ShovelItem(ToolMaterial.GOLD, 1.5f, -3.0f, (Item.Properties)properties));
    ...
    public static final Item GOLDEN_AXE = Items.registerItem("golden_axe", (Item.Properties properties) -> new AxeItem(ToolMaterial.GOLD, 6.0f, -3.0f, (Item.Properties)properties));
    public static final Item GOLDEN_HOE = Items.registerItem("golden_hoe", (Item.Properties properties) -> new HoeItem(ToolMaterial.GOLD, 0.0f, -3.0f, (Item.Properties)properties));
    public static final Item IRON_SWORD = Items.registerItem("iron_sword", new Item.Properties().sword(ToolMaterial.IRON, 3.0f, -2.4f));
    public static final Item IRON_SHOVEL = Items.registerItem("iron_shovel", (Item.Properties properties) -> new ShovelItem(ToolMaterial.IRON, 1.5f, -3.0f, (Item.Properties)properties));
    ...
    public static final Item IRON_AXE = Items.registerItem("iron_axe", (Item.Properties properties) -> new AxeItem(ToolMaterial.IRON, 6.0f, -3.1f, (Item.Properties)properties));
    public static final Item IRON_HOE = Items.registerItem("iron_hoe", (Item.Properties properties) -> new HoeItem(ToolMaterial.IRON, -2.0f, -1.0f, (Item.Properties)properties));
    ...
    public static final Item DIAMOND_SHOVEL = Items.registerItem("diamond_shovel", (Item.Properties properties) -> new ShovelItem(ToolMaterial.DIAMOND, 1.5f, -3.0f, (Item.Properties)properties));
    ...
    public static final Item DIAMOND_AXE = Items.registerItem("diamond_axe", (Item.Properties properties) -> new AxeItem(ToolMaterial.DIAMOND, 5.0f, -3.0f, (Item.Properties)properties));
    public static final Item DIAMOND_HOE = Items.registerItem("diamond_hoe", (Item.Properties properties) -> new HoeItem(ToolMaterial.DIAMOND, -3.0f, 0.0f, (Item.Properties)properties));
    ...
    public static final Item NETHERITE_SHOVEL = Items.registerItem("netherite_shovel", (Item.Properties properties) -> new ShovelItem(ToolMaterial.NETHERITE, 1.5f, -3.0f, (Item.Properties)properties), new Item.Properties().fireResistant());
    ...
    public static final Item NETHERITE_AXE = Items.registerItem("netherite_axe", (Item.Properties properties) -> new AxeItem(ToolMaterial.NETHERITE, 5.0f, -3.0f, (Item.Properties)properties), new Item.Properties().fireResistant());
    public static final Item NETHERITE_HOE = Items.registerItem("netherite_hoe", (Item.Properties properties) -> new HoeItem(ToolMaterial.NETHERITE, -4.0f, 0.0f, (Item.Properties)properties), new Item.Properties().fireResistant());
    ...
    public static final Item PAINTING = Items.registerItem("painting", (Item.Properties properties) -> new HangingEntityItem((EntityType<? extends HangingEntity>)EntityType.PAINTING, (Item.Properties)properties));
    ...
    public static final Item OAK_SIGN = Items.registerBlock(Blocks.OAK_SIGN, (Block block, Item.Properties properties) -> new SignItem((Block)block, Blocks.OAK_WALL_SIGN, (Item.Properties)properties), new Item.Properties().stacksTo(16));
    public static final Item SPRUCE_SIGN = Items.registerBlock(Blocks.SPRUCE_SIGN, (Block block, Item.Properties properties) -> new SignItem((Block)block, Blocks.SPRUCE_WALL_SIGN, (Item.Properties)properties), new Item.Properties().stacksTo(16));
    public static final Item BIRCH_SIGN = Items.registerBlock(Blocks.BIRCH_SIGN, (Block block, Item.Properties properties) -> new SignItem((Block)block, Blocks.BIRCH_WALL_SIGN, (Item.Properties)properties), new Item.Properties().stacksTo(16));
    public static final Item JUNGLE_SIGN = Items.registerBlock(Blocks.JUNGLE_SIGN, (Block block, Item.Properties properties) -> new SignItem((Block)block, Blocks.JUNGLE_WALL_SIGN, (Item.Properties)properties), new Item.Properties().stacksTo(16));
    public static final Item ACACIA_SIGN = Items.registerBlock(Blocks.ACACIA_SIGN, (Block block, Item.Properties properties) -> new SignItem((Block)block, Blocks.ACACIA_WALL_SIGN, (Item.Properties)properties), new Item.Properties().stacksTo(16));
    public static final Item CHERRY_SIGN = Items.registerBlock(Blocks.CHERRY_SIGN, (Block block, Item.Properties properties) -> new SignItem((Block)block, Blocks.CHERRY_WALL_SIGN, (Item.Properties)properties), new Item.Properties().stacksTo(16));
    public static final Item DARK_OAK_SIGN = Items.registerBlock(Blocks.DARK_OAK_SIGN, (Block block, Item.Properties properties) -> new SignItem((Block)block, Blocks.DARK_OAK_WALL_SIGN, (Item.Properties)properties), new Item.Properties().stacksTo(16));
    public static final Item PALE_OAK_SIGN = Items.registerBlock(Blocks.PALE_OAK_SIGN, (Block block, Item.Properties properties) -> new SignItem((Block)block, Blocks.PALE_OAK_WALL_SIGN, (Item.Properties)properties), new Item.Properties().stacksTo(16));
    public static final Item MANGROVE_SIGN = Items.registerBlock(Blocks.MANGROVE_SIGN, (Block block, Item.Properties properties) -> new SignItem((Block)block, Blocks.MANGROVE_WALL_SIGN, (Item.Properties)properties), new Item.Properties().stacksTo(16));
    public static final Item BAMBOO_SIGN = Items.registerBlock(Blocks.BAMBOO_SIGN, (Block block, Item.Properties properties) -> new SignItem((Block)block, Blocks.BAMBOO_WALL_SIGN, (Item.Properties)properties), new Item.Properties().stacksTo(16));
    public static final Item CRIMSON_SIGN = Items.registerBlock(Blocks.CRIMSON_SIGN, (Block block, Item.Properties properties) -> new SignItem((Block)block, Blocks.CRIMSON_WALL_SIGN, (Item.Properties)properties), new Item.Properties().stacksTo(16));
    public static final Item WARPED_SIGN = Items.registerBlock(Blocks.WARPED_SIGN, (Block block, Item.Properties properties) -> new SignItem((Block)block, Blocks.WARPED_WALL_SIGN, (Item.Properties)properties), new Item.Properties().stacksTo(16));
    public static final Item OAK_HANGING_SIGN = Items.registerBlock(Blocks.OAK_HANGING_SIGN, (Block block, Item.Properties properties) -> new HangingSignItem((Block)block, Blocks.OAK_WALL_HANGING_SIGN, (Item.Properties)properties), new Item.Properties().stacksTo(16));
    public static final Item SPRUCE_HANGING_SIGN = Items.registerBlock(Blocks.SPRUCE_HANGING_SIGN, (Block block, Item.Properties properties) -> new HangingSignItem((Block)block, Blocks.SPRUCE_WALL_HANGING_SIGN, (Item.Properties)properties), new Item.Properties().stacksTo(16));
    public static final Item BIRCH_HANGING_SIGN = Items.registerBlock(Blocks.BIRCH_HANGING_SIGN, (Block block, Item.Properties properties) -> new HangingSignItem((Block)block, Blocks.BIRCH_WALL_HANGING_SIGN, (Item.Properties)properties), new Item.Properties().stacksTo(16));
    public static final Item JUNGLE_HANGING_SIGN = Items.registerBlock(Blocks.JUNGLE_HANGING_SIGN, (Block block, Item.Properties properties) -> new HangingSignItem((Block)block, Blocks.JUNGLE_WALL_HANGING_SIGN, (Item.Properties)properties), new Item.Properties().stacksTo(16));
    public static final Item ACACIA_HANGING_SIGN = Items.registerBlock(Blocks.ACACIA_HANGING_SIGN, (Block block, Item.Properties properties) -> new HangingSignItem((Block)block, Blocks.ACACIA_WALL_HANGING_SIGN, (Item.Properties)properties), new Item.Properties().stacksTo(16));
    public static final Item CHERRY_HANGING_SIGN = Items.registerBlock(Blocks.CHERRY_HANGING_SIGN, (Block block, Item.Properties properties) -> new HangingSignItem((Block)block, Blocks.CHERRY_WALL_HANGING_SIGN, (Item.Properties)properties), new Item.Properties().stacksTo(16));
    public static final Item DARK_OAK_HANGING_SIGN = Items.registerBlock(Blocks.DARK_OAK_HANGING_SIGN, (Block block, Item.Properties properties) -> new HangingSignItem((Block)block, Blocks.DARK_OAK_WALL_HANGING_SIGN, (Item.Properties)properties), new Item.Properties().stacksTo(16));
    public static final Item PALE_OAK_HANGING_SIGN = Items.registerBlock(Blocks.PALE_OAK_HANGING_SIGN, (Block block, Item.Properties properties) -> new HangingSignItem((Block)block, Blocks.PALE_OAK_WALL_HANGING_SIGN, (Item.Properties)properties), new Item.Properties().stacksTo(16));
    public static final Item MANGROVE_HANGING_SIGN = Items.registerBlock(Blocks.MANGROVE_HANGING_SIGN, (Block block, Item.Properties properties) -> new HangingSignItem((Block)block, Blocks.MANGROVE_WALL_HANGING_SIGN, (Item.Properties)properties), new Item.Properties().stacksTo(16));
    public static final Item BAMBOO_HANGING_SIGN = Items.registerBlock(Blocks.BAMBOO_HANGING_SIGN, (Block block, Item.Properties properties) -> new HangingSignItem((Block)block, Blocks.BAMBOO_WALL_HANGING_SIGN, (Item.Properties)properties), new Item.Properties().stacksTo(16));
    public static final Item CRIMSON_HANGING_SIGN = Items.registerBlock(Blocks.CRIMSON_HANGING_SIGN, (Block block, Item.Properties properties) -> new HangingSignItem((Block)block, Blocks.CRIMSON_WALL_HANGING_SIGN, (Item.Properties)properties), new Item.Properties().stacksTo(16));
    public static final Item WARPED_HANGING_SIGN = Items.registerBlock(Blocks.WARPED_HANGING_SIGN, (Block block, Item.Properties properties) -> new HangingSignItem((Block)block, Blocks.WARPED_WALL_HANGING_SIGN, (Item.Properties)properties), new Item.Properties().stacksTo(16));
    public static final Item BUCKET = Items.registerItem("bucket", (Item.Properties properties) -> new BucketItem(Fluids.EMPTY, (Item.Properties)properties), new Item.Properties().stacksTo(16));
    public static final Item WATER_BUCKET = Items.registerItem("water_bucket", (Item.Properties properties) -> new BucketItem(Fluids.WATER, (Item.Properties)properties), new Item.Properties().craftRemainder(BUCKET).stacksTo(1));
    public static final Item LAVA_BUCKET = Items.registerItem("lava_bucket", (Item.Properties properties) -> new BucketItem(Fluids.LAVA, (Item.Properties)properties), new Item.Properties().craftRemainder(BUCKET).stacksTo(1));
    public static final Item POWDER_SNOW_BUCKET = Items.registerItem("powder_snow_bucket", (Item.Properties properties) -> new SolidBucketItem(Blocks.POWDER_SNOW, SoundEvents.BUCKET_EMPTY_POWDER_SNOW, (Item.Properties)properties), new Item.Properties().stacksTo(1).useItemDescriptionPrefix());
    ...
    public static final Item PUFFERFISH_BUCKET = Items.registerItem("pufferfish_bucket", (Item.Properties properties) -> new MobBucketItem((EntityType<? extends Mob>)EntityType.PUFFERFISH, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, (Item.Properties)properties), new Item.Properties().stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY));
    public static final Item SALMON_BUCKET = Items.registerItem("salmon_bucket", (Item.Properties properties) -> new MobBucketItem((EntityType<? extends Mob>)EntityType.SALMON, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, (Item.Properties)properties), new Item.Properties().stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY));
    public static final Item COD_BUCKET = Items.registerItem("cod_bucket", (Item.Properties properties) -> new MobBucketItem((EntityType<? extends Mob>)EntityType.COD, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, (Item.Properties)properties), new Item.Properties().stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY));
    public static final Item TROPICAL_FISH_BUCKET = Items.registerItem("tropical_fish_bucket", (Item.Properties properties) -> new MobBucketItem((EntityType<? extends Mob>)EntityType.TROPICAL_FISH, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, (Item.Properties)properties), new Item.Properties().stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY));
    public static final Item AXOLOTL_BUCKET = Items.registerItem("axolotl_bucket", (Item.Properties properties) -> new MobBucketItem((EntityType<? extends Mob>)EntityType.AXOLOTL, Fluids.WATER, SoundEvents.BUCKET_EMPTY_AXOLOTL, (Item.Properties)properties), new Item.Properties().stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY));
    public static final Item TADPOLE_BUCKET = Items.registerItem("tadpole_bucket", (Item.Properties properties) -> new MobBucketItem((EntityType<? extends Mob>)EntityType.TADPOLE, Fluids.WATER, SoundEvents.BUCKET_EMPTY_TADPOLE, (Item.Properties)properties), new Item.Properties().stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY));
    ...
    public static final Item WHITE_DYE = Items.registerItem("white_dye", (Item.Properties properties) -> new DyeItem(DyeColor.WHITE, (Item.Properties)properties));
    public static final Item ORANGE_DYE = Items.registerItem("orange_dye", (Item.Properties properties) -> new DyeItem(DyeColor.ORANGE, (Item.Properties)properties));
    public static final Item MAGENTA_DYE = Items.registerItem("magenta_dye", (Item.Properties properties) -> new DyeItem(DyeColor.MAGENTA, (Item.Properties)properties));
    public static final Item LIGHT_BLUE_DYE = Items.registerItem("light_blue_dye", (Item.Properties properties) -> new DyeItem(DyeColor.LIGHT_BLUE, (Item.Properties)properties));
    public static final Item YELLOW_DYE = Items.registerItem("yellow_dye", (Item.Properties properties) -> new DyeItem(DyeColor.YELLOW, (Item.Properties)properties));
    public static final Item LIME_DYE = Items.registerItem("lime_dye", (Item.Properties properties) -> new DyeItem(DyeColor.LIME, (Item.Properties)properties));
    public static final Item PINK_DYE = Items.registerItem("pink_dye", (Item.Properties properties) -> new DyeItem(DyeColor.PINK, (Item.Properties)properties));
    public static final Item GRAY_DYE = Items.registerItem("gray_dye", (Item.Properties properties) -> new DyeItem(DyeColor.GRAY, (Item.Properties)properties));
    public static final Item LIGHT_GRAY_DYE = Items.registerItem("light_gray_dye", (Item.Properties properties) -> new DyeItem(DyeColor.LIGHT_GRAY, (Item.Properties)properties));
    public static final Item CYAN_DYE = Items.registerItem("cyan_dye", (Item.Properties properties) -> new DyeItem(DyeColor.CYAN, (Item.Properties)properties));
    public static final Item PURPLE_DYE = Items.registerItem("purple_dye", (Item.Properties properties) -> new DyeItem(DyeColor.PURPLE, (Item.Properties)properties));
    public static final Item BLUE_DYE = Items.registerItem("blue_dye", (Item.Properties properties) -> new DyeItem(DyeColor.BLUE, (Item.Properties)properties));
    public static final Item BROWN_DYE = Items.registerItem("brown_dye", (Item.Properties properties) -> new DyeItem(DyeColor.BROWN, (Item.Properties)properties));
    public static final Item GREEN_DYE = Items.registerItem("green_dye", (Item.Properties properties) -> new DyeItem(DyeColor.GREEN, (Item.Properties)properties));
    public static final Item RED_DYE = Items.registerItem("red_dye", (Item.Properties properties) -> new DyeItem(DyeColor.RED, (Item.Properties)properties));
    public static final Item BLACK_DYE = Items.registerItem("black_dye", (Item.Properties properties) -> new DyeItem(DyeColor.BLACK, (Item.Properties)properties));
    ...
    public static final Item CRAFTER = Items.registerBlock(Blocks.CRAFTER, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    ...
    public static final Item BREWING_STAND = Items.registerBlock(Blocks.BREWING_STAND, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    ...
    public static final Item ARMADILLO_SPAWN_EGG = Items.registerItem("armadillo_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.ARMADILLO, (Item.Properties)properties));
    public static final Item ALLAY_SPAWN_EGG = Items.registerItem("allay_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.ALLAY, (Item.Properties)properties));
    public static final Item AXOLOTL_SPAWN_EGG = Items.registerItem("axolotl_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.AXOLOTL, (Item.Properties)properties));
    public static final Item BAT_SPAWN_EGG = Items.registerItem("bat_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.BAT, (Item.Properties)properties));
    public static final Item BEE_SPAWN_EGG = Items.registerItem("bee_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.BEE, (Item.Properties)properties));
    public static final Item BLAZE_SPAWN_EGG = Items.registerItem("blaze_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.BLAZE, (Item.Properties)properties));
    public static final Item BOGGED_SPAWN_EGG = Items.registerItem("bogged_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.BOGGED, (Item.Properties)properties));
    public static final Item BREEZE_SPAWN_EGG = Items.registerItem("breeze_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.BREEZE, (Item.Properties)properties));
    public static final Item CAT_SPAWN_EGG = Items.registerItem("cat_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.CAT, (Item.Properties)properties));
    public static final Item CAMEL_SPAWN_EGG = Items.registerItem("camel_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.CAMEL, (Item.Properties)properties));
    public static final Item CAVE_SPIDER_SPAWN_EGG = Items.registerItem("cave_spider_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.CAVE_SPIDER, (Item.Properties)properties));
    public static final Item CHICKEN_SPAWN_EGG = Items.registerItem("chicken_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.CHICKEN, (Item.Properties)properties));
    public static final Item COD_SPAWN_EGG = Items.registerItem("cod_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.COD, (Item.Properties)properties));
    public static final Item COW_SPAWN_EGG = Items.registerItem("cow_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.COW, (Item.Properties)properties));
    public static final Item CREEPER_SPAWN_EGG = Items.registerItem("creeper_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.CREEPER, (Item.Properties)properties));
    public static final Item DOLPHIN_SPAWN_EGG = Items.registerItem("dolphin_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.DOLPHIN, (Item.Properties)properties));
    public static final Item DONKEY_SPAWN_EGG = Items.registerItem("donkey_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.DONKEY, (Item.Properties)properties));
    public static final Item DROWNED_SPAWN_EGG = Items.registerItem("drowned_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.DROWNED, (Item.Properties)properties));
    public static final Item ELDER_GUARDIAN_SPAWN_EGG = Items.registerItem("elder_guardian_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.ELDER_GUARDIAN, (Item.Properties)properties));
    public static final Item ENDER_DRAGON_SPAWN_EGG = Items.registerItem("ender_dragon_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.ENDER_DRAGON, (Item.Properties)properties));
    public static final Item ENDERMAN_SPAWN_EGG = Items.registerItem("enderman_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.ENDERMAN, (Item.Properties)properties));
    public static final Item ENDERMITE_SPAWN_EGG = Items.registerItem("endermite_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.ENDERMITE, (Item.Properties)properties));
    public static final Item EVOKER_SPAWN_EGG = Items.registerItem("evoker_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.EVOKER, (Item.Properties)properties));
    public static final Item FOX_SPAWN_EGG = Items.registerItem("fox_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.FOX, (Item.Properties)properties));
    public static final Item FROG_SPAWN_EGG = Items.registerItem("frog_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.FROG, (Item.Properties)properties));
    public static final Item GHAST_SPAWN_EGG = Items.registerItem("ghast_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.GHAST, (Item.Properties)properties));
    public static final Item HAPPY_GHAST_SPAWN_EGG = Items.registerItem("happy_ghast_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.HAPPY_GHAST, (Item.Properties)properties));
    public static final Item GLOW_SQUID_SPAWN_EGG = Items.registerItem("glow_squid_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.GLOW_SQUID, (Item.Properties)properties));
    public static final Item GOAT_SPAWN_EGG = Items.registerItem("goat_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.GOAT, (Item.Properties)properties));
    public static final Item GUARDIAN_SPAWN_EGG = Items.registerItem("guardian_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.GUARDIAN, (Item.Properties)properties));
    public static final Item HOGLIN_SPAWN_EGG = Items.registerItem("hoglin_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.HOGLIN, (Item.Properties)properties));
    public static final Item HORSE_SPAWN_EGG = Items.registerItem("horse_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.HORSE, (Item.Properties)properties));
    public static final Item HUSK_SPAWN_EGG = Items.registerItem("husk_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.HUSK, (Item.Properties)properties));
    public static final Item IRON_GOLEM_SPAWN_EGG = Items.registerItem("iron_golem_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.IRON_GOLEM, (Item.Properties)properties));
    public static final Item LLAMA_SPAWN_EGG = Items.registerItem("llama_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.LLAMA, (Item.Properties)properties));
    public static final Item MAGMA_CUBE_SPAWN_EGG = Items.registerItem("magma_cube_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.MAGMA_CUBE, (Item.Properties)properties));
    public static final Item MOOSHROOM_SPAWN_EGG = Items.registerItem("mooshroom_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.MOOSHROOM, (Item.Properties)properties));
    public static final Item MULE_SPAWN_EGG = Items.registerItem("mule_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.MULE, (Item.Properties)properties));
    public static final Item OCELOT_SPAWN_EGG = Items.registerItem("ocelot_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.OCELOT, (Item.Properties)properties));
    public static final Item PANDA_SPAWN_EGG = Items.registerItem("panda_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.PANDA, (Item.Properties)properties));
    public static final Item PARROT_SPAWN_EGG = Items.registerItem("parrot_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.PARROT, (Item.Properties)properties));
    public static final Item PHANTOM_SPAWN_EGG = Items.registerItem("phantom_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.PHANTOM, (Item.Properties)properties));
    public static final Item PIG_SPAWN_EGG = Items.registerItem("pig_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.PIG, (Item.Properties)properties));
    public static final Item PIGLIN_SPAWN_EGG = Items.registerItem("piglin_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.PIGLIN, (Item.Properties)properties));
    public static final Item PIGLIN_BRUTE_SPAWN_EGG = Items.registerItem("piglin_brute_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.PIGLIN_BRUTE, (Item.Properties)properties));
    public static final Item PILLAGER_SPAWN_EGG = Items.registerItem("pillager_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.PILLAGER, (Item.Properties)properties));
    public static final Item POLAR_BEAR_SPAWN_EGG = Items.registerItem("polar_bear_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.POLAR_BEAR, (Item.Properties)properties));
    public static final Item PUFFERFISH_SPAWN_EGG = Items.registerItem("pufferfish_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.PUFFERFISH, (Item.Properties)properties));
    public static final Item RABBIT_SPAWN_EGG = Items.registerItem("rabbit_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.RABBIT, (Item.Properties)properties));
    public static final Item RAVAGER_SPAWN_EGG = Items.registerItem("ravager_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.RAVAGER, (Item.Properties)properties));
    public static final Item SALMON_SPAWN_EGG = Items.registerItem("salmon_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.SALMON, (Item.Properties)properties));
    public static final Item SHEEP_SPAWN_EGG = Items.registerItem("sheep_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.SHEEP, (Item.Properties)properties));
    public static final Item SHULKER_SPAWN_EGG = Items.registerItem("shulker_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.SHULKER, (Item.Properties)properties));
    public static final Item SILVERFISH_SPAWN_EGG = Items.registerItem("silverfish_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.SILVERFISH, (Item.Properties)properties));
    public static final Item SKELETON_SPAWN_EGG = Items.registerItem("skeleton_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.SKELETON, (Item.Properties)properties));
    public static final Item SKELETON_HORSE_SPAWN_EGG = Items.registerItem("skeleton_horse_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.SKELETON_HORSE, (Item.Properties)properties));
    public static final Item SLIME_SPAWN_EGG = Items.registerItem("slime_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.SLIME, (Item.Properties)properties));
    public static final Item SNIFFER_SPAWN_EGG = Items.registerItem("sniffer_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.SNIFFER, (Item.Properties)properties));
    public static final Item SNOW_GOLEM_SPAWN_EGG = Items.registerItem("snow_golem_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.SNOW_GOLEM, (Item.Properties)properties));
    public static final Item SPIDER_SPAWN_EGG = Items.registerItem("spider_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.SPIDER, (Item.Properties)properties));
    public static final Item SQUID_SPAWN_EGG = Items.registerItem("squid_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.SQUID, (Item.Properties)properties));
    public static final Item STRAY_SPAWN_EGG = Items.registerItem("stray_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.STRAY, (Item.Properties)properties));
    public static final Item STRIDER_SPAWN_EGG = Items.registerItem("strider_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.STRIDER, (Item.Properties)properties));
    public static final Item TADPOLE_SPAWN_EGG = Items.registerItem("tadpole_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.TADPOLE, (Item.Properties)properties));
    public static final Item TRADER_LLAMA_SPAWN_EGG = Items.registerItem("trader_llama_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.TRADER_LLAMA, (Item.Properties)properties));
    public static final Item TROPICAL_FISH_SPAWN_EGG = Items.registerItem("tropical_fish_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.TROPICAL_FISH, (Item.Properties)properties));
    public static final Item TURTLE_SPAWN_EGG = Items.registerItem("turtle_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.TURTLE, (Item.Properties)properties));
    public static final Item VEX_SPAWN_EGG = Items.registerItem("vex_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.VEX, (Item.Properties)properties));
    public static final Item VILLAGER_SPAWN_EGG = Items.registerItem("villager_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.VILLAGER, (Item.Properties)properties));
    public static final Item VINDICATOR_SPAWN_EGG = Items.registerItem("vindicator_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.VINDICATOR, (Item.Properties)properties));
    public static final Item WANDERING_TRADER_SPAWN_EGG = Items.registerItem("wandering_trader_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.WANDERING_TRADER, (Item.Properties)properties));
    public static final Item WARDEN_SPAWN_EGG = Items.registerItem("warden_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.WARDEN, (Item.Properties)properties));
    public static final Item WITCH_SPAWN_EGG = Items.registerItem("witch_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.WITCH, (Item.Properties)properties));
    public static final Item WITHER_SPAWN_EGG = Items.registerItem("wither_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.WITHER, (Item.Properties)properties));
    public static final Item WITHER_SKELETON_SPAWN_EGG = Items.registerItem("wither_skeleton_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.WITHER_SKELETON, (Item.Properties)properties));
    public static final Item WOLF_SPAWN_EGG = Items.registerItem("wolf_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.WOLF, (Item.Properties)properties));
    public static final Item ZOGLIN_SPAWN_EGG = Items.registerItem("zoglin_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.ZOGLIN, (Item.Properties)properties));
    public static final Item CREAKING_SPAWN_EGG = Items.registerItem("creaking_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.CREAKING, (Item.Properties)properties));
    public static final Item ZOMBIE_SPAWN_EGG = Items.registerItem("zombie_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.ZOMBIE, (Item.Properties)properties));
    public static final Item ZOMBIE_HORSE_SPAWN_EGG = Items.registerItem("zombie_horse_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.ZOMBIE_HORSE, (Item.Properties)properties));
    public static final Item ZOMBIE_VILLAGER_SPAWN_EGG = Items.registerItem("zombie_villager_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.ZOMBIE_VILLAGER, (Item.Properties)properties));
    public static final Item ZOMBIFIED_PIGLIN_SPAWN_EGG = Items.registerItem("zombified_piglin_spawn_egg", (Item.Properties properties) -> new SpawnEggItem((EntityType<? extends Mob>)EntityType.ZOMBIFIED_PIGLIN, (Item.Properties)properties));
    ...
    public static final Item ITEM_FRAME = Items.registerItem("item_frame", (Item.Properties properties) -> new ItemFrameItem((EntityType<? extends HangingEntity>)EntityType.ITEM_FRAME, (Item.Properties)properties));
    public static final Item GLOW_ITEM_FRAME = Items.registerItem("glow_item_frame", (Item.Properties properties) -> new ItemFrameItem((EntityType<? extends HangingEntity>)EntityType.GLOW_ITEM_FRAME, (Item.Properties)properties));
    ...
    public static final Item SKELETON_SKULL = Items.registerBlock(Blocks.SKELETON_SKULL, (Block block, Item.Properties properties) -> new StandingAndWallBlockItem((Block)block, Blocks.SKELETON_WALL_SKULL, Direction.DOWN, Waypoint.addHideAttribute(properties)), new Item.Properties().rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD));
    public static final Item WITHER_SKELETON_SKULL = Items.registerBlock(Blocks.WITHER_SKELETON_SKULL, (Block block, Item.Properties properties) -> new StandingAndWallBlockItem((Block)block, Blocks.WITHER_SKELETON_WALL_SKULL, Direction.DOWN, Waypoint.addHideAttribute(properties)), new Item.Properties().rarity(Rarity.RARE).equippableUnswappable(EquipmentSlot.HEAD));
    public static final Item PLAYER_HEAD = Items.registerBlock(Blocks.PLAYER_HEAD, (Block block, Item.Properties properties) -> new PlayerHeadItem((Block)block, Blocks.PLAYER_WALL_HEAD, Waypoint.addHideAttribute(properties)), new Item.Properties().rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD));
    public static final Item ZOMBIE_HEAD = Items.registerBlock(Blocks.ZOMBIE_HEAD, (Block block, Item.Properties properties) -> new StandingAndWallBlockItem((Block)block, Blocks.ZOMBIE_WALL_HEAD, Direction.DOWN, Waypoint.addHideAttribute(properties)), new Item.Properties().rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD));
    public static final Item CREEPER_HEAD = Items.registerBlock(Blocks.CREEPER_HEAD, (Block block, Item.Properties properties) -> new StandingAndWallBlockItem((Block)block, Blocks.CREEPER_WALL_HEAD, Direction.DOWN, Waypoint.addHideAttribute(properties)), new Item.Properties().rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD));
    public static final Item DRAGON_HEAD = Items.registerBlock(Blocks.DRAGON_HEAD, (Block block, Item.Properties properties) -> new StandingAndWallBlockItem((Block)block, Blocks.DRAGON_WALL_HEAD, Direction.DOWN, Waypoint.addHideAttribute(properties)), new Item.Properties().rarity(Rarity.EPIC).equippableUnswappable(EquipmentSlot.HEAD));
    public static final Item PIGLIN_HEAD = Items.registerBlock(Blocks.PIGLIN_HEAD, (Block block, Item.Properties properties) -> new StandingAndWallBlockItem((Block)block, Blocks.PIGLIN_WALL_HEAD, Direction.DOWN, Waypoint.addHideAttribute(properties)), new Item.Properties().rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD));
    ...
    public static final Item COMMAND_BLOCK_MINECART = Items.registerItem("command_block_minecart", (Item.Properties properties) -> new MinecartItem((EntityType<? extends AbstractMinecart>)EntityType.COMMAND_BLOCK_MINECART, (Item.Properties)properties), new Item.Properties().stacksTo(1).rarity(Rarity.EPIC));
    ...
    public static final Item WHITE_BANNER = Items.registerBlock(Blocks.WHITE_BANNER, (Block block, Item.Properties properties) -> new BannerItem((Block)block, Blocks.WHITE_WALL_BANNER, (Item.Properties)properties), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item ORANGE_BANNER = Items.registerBlock(Blocks.ORANGE_BANNER, (Block block, Item.Properties properties) -> new BannerItem((Block)block, Blocks.ORANGE_WALL_BANNER, (Item.Properties)properties), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item MAGENTA_BANNER = Items.registerBlock(Blocks.MAGENTA_BANNER, (Block block, Item.Properties properties) -> new BannerItem((Block)block, Blocks.MAGENTA_WALL_BANNER, (Item.Properties)properties), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item LIGHT_BLUE_BANNER = Items.registerBlock(Blocks.LIGHT_BLUE_BANNER, (Block block, Item.Properties properties) -> new BannerItem((Block)block, Blocks.LIGHT_BLUE_WALL_BANNER, (Item.Properties)properties), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item YELLOW_BANNER = Items.registerBlock(Blocks.YELLOW_BANNER, (Block block, Item.Properties properties) -> new BannerItem((Block)block, Blocks.YELLOW_WALL_BANNER, (Item.Properties)properties), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item LIME_BANNER = Items.registerBlock(Blocks.LIME_BANNER, (Block block, Item.Properties properties) -> new BannerItem((Block)block, Blocks.LIME_WALL_BANNER, (Item.Properties)properties), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item PINK_BANNER = Items.registerBlock(Blocks.PINK_BANNER, (Block block, Item.Properties properties) -> new BannerItem((Block)block, Blocks.PINK_WALL_BANNER, (Item.Properties)properties), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item GRAY_BANNER = Items.registerBlock(Blocks.GRAY_BANNER, (Block block, Item.Properties properties) -> new BannerItem((Block)block, Blocks.GRAY_WALL_BANNER, (Item.Properties)properties), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item LIGHT_GRAY_BANNER = Items.registerBlock(Blocks.LIGHT_GRAY_BANNER, (Block block, Item.Properties properties) -> new BannerItem((Block)block, Blocks.LIGHT_GRAY_WALL_BANNER, (Item.Properties)properties), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item CYAN_BANNER = Items.registerBlock(Blocks.CYAN_BANNER, (Block block, Item.Properties properties) -> new BannerItem((Block)block, Blocks.CYAN_WALL_BANNER, (Item.Properties)properties), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item PURPLE_BANNER = Items.registerBlock(Blocks.PURPLE_BANNER, (Block block, Item.Properties properties) -> new BannerItem((Block)block, Blocks.PURPLE_WALL_BANNER, (Item.Properties)properties), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item BLUE_BANNER = Items.registerBlock(Blocks.BLUE_BANNER, (Block block, Item.Properties properties) -> new BannerItem((Block)block, Blocks.BLUE_WALL_BANNER, (Item.Properties)properties), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item BROWN_BANNER = Items.registerBlock(Blocks.BROWN_BANNER, (Block block, Item.Properties properties) -> new BannerItem((Block)block, Blocks.BROWN_WALL_BANNER, (Item.Properties)properties), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item GREEN_BANNER = Items.registerBlock(Blocks.GREEN_BANNER, (Block block, Item.Properties properties) -> new BannerItem((Block)block, Blocks.GREEN_WALL_BANNER, (Item.Properties)properties), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item RED_BANNER = Items.registerBlock(Blocks.RED_BANNER, (Block block, Item.Properties properties) -> new BannerItem((Block)block, Blocks.RED_WALL_BANNER, (Item.Properties)properties), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item BLACK_BANNER = Items.registerBlock(Blocks.BLACK_BANNER, (Block block, Item.Properties properties) -> new BannerItem((Block)block, Blocks.BLACK_WALL_BANNER, (Item.Properties)properties), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    ...
    public static final Item BARREL = Items.registerBlock(Blocks.BARREL, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item SMOKER = Items.registerBlock(Blocks.SMOKER, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item BLAST_FURNACE = Items.registerBlock(Blocks.BLAST_FURNACE, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    ...
    public static final Item CAMPFIRE = Items.registerBlock(Blocks.CAMPFIRE, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item SOUL_CAMPFIRE = Items.registerBlock(Blocks.SOUL_CAMPFIRE, properties -> properties.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    ...
    public static Item registerBlock(Block block) {
        return Items.registerBlock(block, BlockItem::new);
    }

    public static Item registerBlock(Block block, Item.Properties properties) {
        return Items.registerBlock(block, BlockItem::new, properties);
    }

    public static Item registerBlock(Block block2, UnaryOperator<Item.Properties> unaryOperator) {
        return Items.registerBlock(block2, (Block block, Item.Properties properties) -> new BlockItem((Block)block, (Item.Properties)unaryOperator.apply((Item.Properties)properties)));
    }

    public static Item registerBlock(Block block, Block ... blockArray) {
    ...
    public static Item registerBlock(Block block, BiFunction<Block, Item.Properties, Item> biFunction) {
        return Items.registerBlock(block, biFunction, new Item.Properties());
    }

    public static Item registerBlock(Block block, BiFunction<Block, Item.Properties, Item> biFunction, Item.Properties properties2) {
        return Items.registerItem(Items.blockIdToItemId(block.builtInRegistryHolder().key()), (Item.Properties properties) -> (Item)biFunction.apply(block, (Item.Properties)properties), properties2.useBlockDescriptionPrefix());
    }

    public static Item registerItem(String string, Function<Item.Properties, Item> function) {
        return Items.registerItem(Items.vanillaItemId(string), function, new Item.Properties());
    }

    public static Item registerItem(String string, Function<Item.Properties, Item> function, Item.Properties properties) {
        return Items.registerItem(Items.vanillaItemId(string), function, properties);
    }

    public static Item registerItem(String string, Item.Properties properties) {
        return Items.registerItem(Items.vanillaItemId(string), Item::new, properties);
    }

    public static Item registerItem(String string) {
        return Items.registerItem(Items.vanillaItemId(string), Item::new, new Item.Properties());
    }

    public static Item registerItem(ResourceKey<Item> resourceKey, Function<Item.Properties, Item> function) {
        return Items.registerItem(resourceKey, function, new Item.Properties());
    }
