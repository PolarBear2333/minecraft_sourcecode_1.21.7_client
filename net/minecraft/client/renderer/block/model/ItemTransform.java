...
public record ItemTransform(Vector3fc rotation, Vector3fc translation, Vector3fc scale) {
    ...
    public void apply(boolean bl, PoseStack.Pose pose) {
        ...
        pose.translate(f3, this.translation.y(), this.translation.z());
        pose.rotate((Quaternionfc)new Quaternionf().rotationXYZ(this.rotation.x() * ((float)Math.PI / 180), f2 * ((float)Math.PI / 180), f * ((float)Math.PI / 180)));
