...
{
    public static final Codec<FrogVariant> DIRECT_CODEC = RecordCodecBuilder.create(instance -> instance.group((App)ClientAsset.DEFAULT_FIELD_CODEC.forGetter(FrogVariant::assetInfo), (App)SpawnPrioritySelectors.CODEC.fieldOf("spawn_conditions").forGetter(FrogVariant::spawnConditions)).apply((Applicative)instance, FrogVariant::new));
    public static final Codec<FrogVariant> NETWORK_CODEC = RecordCodecBuilder.create(instance -> instance.group((App)ClientAsset.DEFAULT_FIELD_CODEC.forGetter(FrogVariant::assetInfo)).apply((Applicative)instance, FrogVariant::new));
