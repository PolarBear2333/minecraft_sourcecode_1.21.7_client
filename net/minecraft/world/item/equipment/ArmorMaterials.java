...
public interface ArmorMaterials {
    ...
    private static Map<ArmorType, Integer> makeDefense(int n, int n2, int n3, int n4, int n5) {
        return Maps.newEnumMap(Map.of(ArmorType.BOOTS, n, ArmorType.LEGGINGS, n2, ArmorType.CHESTPLATE, n3, ArmorType.HELMET, n4, ArmorType.BODY, n5));
    }
}
