...
extends DataFix {
    ...
    private Dynamic<?> fixPlayer(Dynamic<?> dynamic) {
        ...
        if (optional2.isPresent() && optional3.isPresent() && optional4.isPresent()) {
            optional = dynamic.createMap(Map.of(dynamic.createString("pos"), ExtraDataFixUtils.createBlockPos(dynamic, ((Number)optional2.get()).intValue(), ((Number)optional3.get()).intValue(), ((Number)optional4.get()).intValue())));
