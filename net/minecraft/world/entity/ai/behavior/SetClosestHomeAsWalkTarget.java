...
public class SetClosestHomeAsWalkTarget {
    ...
    public static BehaviorControl<PathfinderMob> create(float f) {
        ...
        return BehaviorBuilder.create(arg_0 -> SetClosestHomeAsWalkTarget.lambda$create$6(mutableLong, (Long2LongMap)long2LongOpenHashMap, f, arg_0));
    }

    private static /* synthetic */ App lambda$create$6(MutableLong mutableLong, Long2LongMap long2LongMap, float f, BehaviorBuilder.Instance instance) {
