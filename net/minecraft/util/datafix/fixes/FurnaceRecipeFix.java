...
extends DataFix {
    ...
    private <R> TypeRewriteRule cap(Type<R> type) {
        ...
        return this.fixTypeEverywhereTyped("FurnaceRecipesFix", type6, type7, typed2 -> typed2.updateTyped(opticFinder, type3, typed -> this.updateFurnaceContents(type, (Type)type2, (Typed<?>)typed)).updateTyped(opticFinder2, type4, typed -> this.updateFurnaceContents(type, (Type)type2, (Typed<?>)typed)).updateTyped(opticFinder3, type5, typed -> this.updateFurnaceContents(type, (Type)type2, (Typed<?>)typed)));
    }
