...
extends IntrinsicHolderTagsProvider<Item> {
    public VanillaItemTagsProvider(PackOutput packOutput, CompletableFuture<HolderLookup.Provider> completableFuture) {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        new BlockItemTagsProvider(){
            ...
            @Override
            protected TagAppender<Block, Block> tag(TagKey<Block> tagKey, TagKey<Item> tagKey2) {
                return new BlockToItemConverter(VanillaItemTagsProvider.this.tag(tagKey2));
            }
        }.run();
        ...
        this.tag(ItemTags.FOOT_ARMOR).add((Item[])new Item[]{Items.LEATHER_BOOTS, Items.CHAINMAIL_BOOTS, Items.GOLDEN_BOOTS, Items.IRON_BOOTS, Items.DIAMOND_BOOTS, Items.NETHERITE_BOOTS});
        this.tag(ItemTags.LEG_ARMOR).add((Item[])new Item[]{Items.LEATHER_LEGGINGS, Items.CHAINMAIL_LEGGINGS, Items.GOLDEN_LEGGINGS, Items.IRON_LEGGINGS, Items.DIAMOND_LEGGINGS, Items.NETHERITE_LEGGINGS});
        this.tag(ItemTags.CHEST_ARMOR).add((Item[])new Item[]{Items.LEATHER_CHESTPLATE, Items.CHAINMAIL_CHESTPLATE, Items.GOLDEN_CHESTPLATE, Items.IRON_CHESTPLATE, Items.DIAMOND_CHESTPLATE, Items.NETHERITE_CHESTPLATE});
        this.tag(ItemTags.HEAD_ARMOR).add((Item[])new Item[]{Items.LEATHER_HELMET, Items.CHAINMAIL_HELMET, Items.GOLDEN_HELMET, Items.IRON_HELMET, Items.DIAMOND_HELMET, Items.NETHERITE_HELMET, Items.TURTLE_HELMET});
        ...
        this.tag(ItemTags.TRIM_MATERIALS).addAll(provider.lookupOrThrow(Registries.ITEM).listElements().filter(reference -> ((Item)reference.value()).components().has(DataComponents.PROVIDES_TRIM_MATERIAL)).sorted(Comparator.comparing(reference -> reference.key().location())).map(Holder.Reference::value));
        ...
        this.tag(ItemTags.DYEABLE).add((Item[])new Item[]{Items.LEATHER_HELMET, Items.LEATHER_CHESTPLATE, Items.LEATHER_LEGGINGS, Items.LEATHER_BOOTS, Items.LEATHER_HORSE_ARMOR, Items.WOLF_ARMOR});
    ...
    implements TagAppender<Block, Block> {
        ...
        public TagAppender<Block, Block> addTag(TagKey<Block> tagKey) {
            this.itemAppender.addTag(BlockToItemConverter.blockTagToItemTag(tagKey));
            return this;
        }

        @Override
        public TagAppender<Block, Block> addOptionalTag(TagKey<Block> tagKey) {
            this.itemAppender.addOptionalTag(BlockToItemConverter.blockTagToItemTag(tagKey));
            return this;
        }
    }
}
