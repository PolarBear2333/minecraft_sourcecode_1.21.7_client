...
public class CubeListBuilder {
    ...
    public CubeListBuilder addBox(String string, float f, float f2, float f3, int n, int n2, int n3, CubeDeformation cubeDeformation, int n4, int n5) {
        this.texOffs(n4, n5);
        this.cubes.add(new CubeDefinition(string, this.xTexOffs, this.yTexOffs, f, f2, f3, n, n2, n3, cubeDeformation, this.mirror, 1.0f, 1.0f, ALL_VISIBLE));
        return this;
    }

    public CubeListBuilder addBox(String string, float f, float f2, float f3, int n, int n2, int n3, int n4, int n5) {
        this.texOffs(n4, n5);
        this.cubes.add(new CubeDefinition(string, this.xTexOffs, this.yTexOffs, f, f2, f3, n, n2, n3, CubeDeformation.NONE, this.mirror, 1.0f, 1.0f, ALL_VISIBLE));
        return this;
    }
    ...
    public CubeListBuilder addBox(String string, float f, float f2, float f3, float f4, float f5, float f6) {
        this.cubes.add(new CubeDefinition(string, this.xTexOffs, this.yTexOffs, f, f2, f3, f4, f5, f6, CubeDeformation.NONE, this.mirror, 1.0f, 1.0f, ALL_VISIBLE));
        return this;
    }
    ...
    public CubeListBuilder addBox(String string, float f, float f2, float f3, float f4, float f5, float f6, CubeDeformation cubeDeformation) {
        this.cubes.add(new CubeDefinition(string, this.xTexOffs, this.yTexOffs, f, f2, f3, f4, f5, f6, cubeDeformation, this.mirror, 1.0f, 1.0f, ALL_VISIBLE));
        return this;
    }

    public CubeListBuilder addBox(float f, float f2, float f3, float f4, float f5, float f6, boolean bl) {
        this.cubes.add(new CubeDefinition(null, this.xTexOffs, this.yTexOffs, f, f2, f3, f4, f5, f6, CubeDeformation.NONE, bl, 1.0f, 1.0f, ALL_VISIBLE));
        return this;
    }
