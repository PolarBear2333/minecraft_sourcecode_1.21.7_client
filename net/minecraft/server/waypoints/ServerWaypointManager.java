...
implements WaypointManager<WaypointTransmitter> {
    ...
    public void updateWaypoint(WaypointTransmitter waypointTransmitter) {
        ...
        for (Object object : ImmutableSet.copyOf(map.entrySet())) {
            this.updateConnection((ServerPlayer)object.getKey(), waypointTransmitter, (WaypointTransmitter.Connection)object.getValue());
        }
        for (Object object : setView) {
            this.createConnection((ServerPlayer)object, waypointTransmitter);
        }
    }
    ...
    public void updatePlayer(ServerPlayer serverPlayer) {
        ...
        for (Object object : ImmutableSet.copyOf(map.entrySet())) {
            this.updateConnection(serverPlayer, (WaypointTransmitter)object.getKey(), (WaypointTransmitter.Connection)object.getValue());
        }
        for (Object object : setView) {
            this.createConnection(serverPlayer, (WaypointTransmitter)object);
        }
    }
