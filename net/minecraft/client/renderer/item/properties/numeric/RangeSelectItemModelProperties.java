...
public class RangeSelectItemModelProperties {
    ...
    public static final MapCodec<RangeSelectItemModelProperty> MAP_CODEC = ID_MAPPER.codec(ResourceLocation.CODEC).dispatchMap("property", RangeSelectItemModelProperty::type, mapCodec -> mapCodec);
