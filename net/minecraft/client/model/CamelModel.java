...
extends EntityModel<CamelRenderState> {
    ...
    private void applyHeadRotation(CamelRenderState camelRenderState, float f, float f2) {
        f = Mth.clamp(f, -30.0f, 30.0f);
        f2 = Mth.clamp(f2, -25.0f, 45.0f);
        if (camelRenderState.jumpCooldown > 0.0f) {
            float f3 = 45.0f * camelRenderState.jumpCooldown / 55.0f;
            f2 = Mth.clamp(f2 + f3, -25.0f, 70.0f);
        }
