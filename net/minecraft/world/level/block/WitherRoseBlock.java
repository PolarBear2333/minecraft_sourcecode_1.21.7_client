...
extends FlowerBlock {
    ...
    public void animateTick(BlockState blockState, Level level, BlockPos blockPos, RandomSource randomSource) {
        ...
        for (int i = 0; i < 3; ++i) {
            ...
            level.addParticle(ParticleTypes.SMOKE, d + randomSource.nextDouble() / 5.0, (double)blockPos.getY() + (0.5 - randomSource.nextDouble()), d2 + randomSource.nextDouble() / 5.0, 0.0, 0.0, 0.0);
        }
    }
