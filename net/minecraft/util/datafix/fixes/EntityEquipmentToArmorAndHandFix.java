...
extends DataFix {
    ...
    private <ItemStackOld, ItemStackNew> TypeRewriteRule cap(Type<ItemStackOld> type, Type<ItemStackNew> type2) {
        Type type3 = DSL.named((String)References.ENTITY_EQUIPMENT.typeName(), (Type)DSL.optional((Type)DSL.field((String)"Equipment", (Type)DSL.list(type))));
        Type type4 = DSL.named((String)References.ENTITY_EQUIPMENT.typeName(), (Type)DSL.and((Type)DSL.optional((Type)DSL.field((String)"ArmorItems", (Type)DSL.list(type2))), (Type)DSL.optional((Type)DSL.field((String)"HandItems", (Type)DSL.list(type2))), (Type)DSL.optional((Type)DSL.field((String)"body_armor_item", type2)), (Type)DSL.optional((Type)DSL.field((String)"saddle", type2))));
        ...
        return TypeRewriteRule.seq((TypeRewriteRule)this.fixTypeEverywhereTyped("EntityEquipmentToArmorAndHandFix - drop chances", this.getInputSchema().getType(References.ENTITY), typed -> typed.update(DSL.remainderFinder(), EntityEquipmentToArmorAndHandFix::fixDropChances)), (TypeRewriteRule)this.fixTypeEverywhere("EntityEquipmentToArmorAndHandFix - equipment", type3, type4, dynamicOps -> {
            ...
            return pair -> pair.mapSecond(either2 -> {
                ...
                if (list.size() > 1) {
                    ArrayList arrayList = Lists.newArrayList((Object[])new Object[]{object, object, object, object});
                    for (int i = 1; i < Math.min(list.size(), 5); ++i) {
                        arrayList.set(i - 1, list.get(i));
                    }
                    either4 = Either.left((Object)arrayList);
                }
    ...
    private static Dynamic<?> fixDropChances(Dynamic<?> dynamic2) {
