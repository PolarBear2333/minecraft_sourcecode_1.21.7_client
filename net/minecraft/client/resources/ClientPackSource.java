...
extends BuiltInPackSource {
    ...
    protected Pack createVanillaPack(PackResources packResources) {
        return Pack.readMetaAndCreate(VANILLA_PACK_INFO, ClientPackSource.fixedResources(packResources), PackType.CLIENT_RESOURCES, VANILLA_SELECTION_CONFIG);
    }

    @Override
    @Nullable
    protected Pack createBuiltinPack(String string, Pack.ResourcesSupplier resourcesSupplier, Component component) {
        return Pack.readMetaAndCreate(ClientPackSource.createBuiltInPackLocation(string, component), resourcesSupplier, PackType.CLIENT_RESOURCES, BUILT_IN_SELECTION_CONFIG);
    }
