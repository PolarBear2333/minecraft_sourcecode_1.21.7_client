...
public class EndCityPieces {
    ...
    static final SectionGenerator HOUSE_TOWER_GENERATOR = new SectionGenerator(){
        ...
        @Override
        public boolean generate(StructureTemplateManager structureTemplateManager, int n, EndCityPiece endCityPiece, BlockPos blockPos, List<StructurePiece> list, RandomSource randomSource) {
            if (n > 8) {
                return false;
            }
            ...
            if (n2 == 0) {
                ...
                EndCityPieces.recursiveChildren(structureTemplateManager, TOWER_GENERATOR, n + 1, endCityPiece2, null, list, randomSource);
            } else if (n2 == 2) {
                endCityPiece2 = EndCityPieces.addHelper(list, EndCityPieces.addPiece(structureTemplateManager, endCityPiece2, new BlockPos(-1, 0, -1), "second_floor_2", rotation, false));
    ...
    static final SectionGenerator TOWER_GENERATOR = new SectionGenerator(){
        ...
        public boolean generate(StructureTemplateManager structureTemplateManager, int n, EndCityPiece endCityPiece, BlockPos blockPos, List<StructurePiece> list, RandomSource randomSource) {
            ...
            int n2 = 1 + randomSource.nextInt(3);
            for (int i = 0; i < n2; ++i) {
                ...
                if (i >= n2 - 1 || !randomSource.nextBoolean()) continue;
            ...
            if (endCityPiece3 != null) {
                for (Tuple<Rotation, BlockPos> tuple : TOWER_BRIDGES) {
                    ...
                    EndCityPieces.recursiveChildren(structureTemplateManager, TOWER_BRIDGE_GENERATOR, n + 1, endCityPiece4, null, list, randomSource);
                }
                ...
                return EndCityPieces.recursiveChildren(structureTemplateManager, FAT_TOWER_GENERATOR, n + 1, endCityPiece2, null, list, randomSource);
            }
            return true;
        }
    };
    static final SectionGenerator TOWER_BRIDGE_GENERATOR = new SectionGenerator(){
        ...
        public boolean generate(StructureTemplateManager structureTemplateManager, int n, EndCityPiece endCityPiece, BlockPos blockPos, List<StructurePiece> list, RandomSource randomSource) {
            Rotation rotation = endCityPiece.placeSettings().getRotation();
            int n2 = randomSource.nextInt(4) + 1;
            ...
            for (int i = 0; i < n2; ++i) {
                if (randomSource.nextBoolean()) {
                    endCityPiece2 = EndCityPieces.addHelper(list, EndCityPieces.addPiece(structureTemplateManager, endCityPiece2, new BlockPos(0, n3, -4), "bridge_piece", rotation, true));
                    n3 = 0;
                    continue;
                }
                endCityPiece2 = randomSource.nextBoolean() ? EndCityPieces.addHelper(list, EndCityPieces.addPiece(structureTemplateManager, endCityPiece2, new BlockPos(0, n3, -4), "bridge_steep_stairs", rotation, true)) : EndCityPieces.addHelper(list, EndCityPieces.addPiece(structureTemplateManager, endCityPiece2, new BlockPos(0, n3, -8), "bridge_gentle_stairs", rotation, true));
                n3 = 4;
            }
            if (this.shipCreated || randomSource.nextInt(10 - n) != 0) {
                if (!EndCityPieces.recursiveChildren(structureTemplateManager, HOUSE_TOWER_GENERATOR, n + 1, endCityPiece2, new BlockPos(-3, n3 + 1, -11), list, randomSource)) {
                    return false;
                }
            } else {
                EndCityPieces.addHelper(list, EndCityPieces.addPiece(structureTemplateManager, endCityPiece2, new BlockPos(-8 + randomSource.nextInt(8), n3, -70 + randomSource.nextInt(10)), "ship", rotation, true));
                this.shipCreated = true;
            }
            endCityPiece2 = EndCityPieces.addHelper(list, EndCityPieces.addPiece(structureTemplateManager, endCityPiece2, new BlockPos(4, n3, 0), "bridge_end", rotation.getRotated(Rotation.CLOCKWISE_180), true));
            endCityPiece2.setGenDepth(-1);
            return true;
        }
    };
    ...
    static final SectionGenerator FAT_TOWER_GENERATOR = new SectionGenerator(){
        ...
        public boolean generate(StructureTemplateManager structureTemplateManager, int n, EndCityPiece endCityPiece, BlockPos blockPos, List<StructurePiece> list, RandomSource randomSource) {
            ...
            for (int i = 0; i < 2 && randomSource.nextInt(3) != 0; ++i) {
                ...
                for (Tuple<Rotation, BlockPos> tuple : FAT_TOWER_BRIDGES) {
                    ...
                    EndCityPieces.recursiveChildren(structureTemplateManager, TOWER_BRIDGE_GENERATOR, n + 1, endCityPiece3, null, list, randomSource);
                }
            }
    ...
    static boolean recursiveChildren(StructureTemplateManager structureTemplateManager, SectionGenerator sectionGenerator, int n, EndCityPiece endCityPiece, BlockPos blockPos, List<StructurePiece> list, RandomSource randomSource) {
        if (n > 8) {
            return false;
        }
        ArrayList arrayList = Lists.newArrayList();
        if (sectionGenerator.generate(structureTemplateManager, n, endCityPiece, blockPos, arrayList, randomSource)) {
            boolean bl = false;
            int n2 = randomSource.nextInt();
            for (StructurePiece structurePiece : arrayList) {
                structurePiece.setGenDepth(n2);
    ...
    extends TemplateStructurePiece {
        ...
        public EndCityPiece(StructureTemplateManager structureTemplateManager, CompoundTag compoundTag) {
            super(StructurePieceType.END_CITY_PIECE, compoundTag, structureTemplateManager, resourceLocation -> EndCityPiece.makeSettings(compoundTag.getBooleanOr("OW", false), compoundTag.read("Rot", Rotation.LEGACY_CODEC).orElseThrow()));
        }
