...
public class ModelLayers {
    ...
    public static ModelLayerLocation createStandingSignModelName(WoodType woodType) {
        return ModelLayers.createLocation("sign/standing/" + woodType.name(), DEFAULT_LAYER);
    }

    public static ModelLayerLocation createWallSignModelName(WoodType woodType) {
        return ModelLayers.createLocation("sign/wall/" + woodType.name(), DEFAULT_LAYER);
    }

    public static ModelLayerLocation createHangingSignModelName(WoodType woodType, HangingSignRenderer.AttachmentType attachmentType) {
        return ModelLayers.createLocation("hanging_sign/" + woodType.name() + "/" + attachmentType.getSerializedName(), DEFAULT_LAYER);
    }
