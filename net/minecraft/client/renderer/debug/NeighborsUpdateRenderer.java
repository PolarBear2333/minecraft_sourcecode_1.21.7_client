...
implements DebugRenderer.SimpleDebugRenderer {
    ...
    public void render(PoseStack poseStack, MultiBufferSource multiBufferSource, double d, double d2, double d3) {
        ...
        for (Map.Entry<Long, Map<BlockPos, Integer>> entry : hashMap.entrySet()) {
            ...
            DebugRenderer.renderFloatingText(poseStack, multiBufferSource, String.valueOf(object), ((Vec3i)comparable).getX(), ((Vec3i)comparable).getY(), ((Vec3i)comparable).getZ(), -1);
        }
    }
}
