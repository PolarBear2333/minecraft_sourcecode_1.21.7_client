...
public class MemoryModuleType<U> {
    ...
    public static final MemoryModuleType<List<Player>> NEAREST_VISIBLE_ATTACKABLE_PLAYERS = MemoryModuleType.register("nearest_visible_targetable_players");
    ...
    public static final MemoryModuleType<Unit> BREEZE_SHOOT_RECOVERING = MemoryModuleType.register("breeze_shoot_recover", Unit.CODEC);
    ...
    private static <U> MemoryModuleType<U> register(String string, Codec<U> codec) {
        return Registry.register(BuiltInRegistries.MEMORY_MODULE_TYPE, ResourceLocation.withDefaultNamespace(string), new MemoryModuleType<U>(Optional.of(codec)));
    }

    private static <U> MemoryModuleType<U> register(String string) {
        return Registry.register(BuiltInRegistries.MEMORY_MODULE_TYPE, ResourceLocation.withDefaultNamespace(string), new MemoryModuleType<U>(Optional.empty()));
    }
}
