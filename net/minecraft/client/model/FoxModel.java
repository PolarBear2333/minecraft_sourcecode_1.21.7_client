...
extends EntityModel<FoxRenderState> {
    ...
    public void setupAnim(FoxRenderState foxRenderState) {
        ...
        float f2 = foxRenderState.walkAnimationSpeed;
        float f3 = foxRenderState.walkAnimationPos;
        this.rightHindLeg.xRot = Mth.cos(f3 * 0.6662f) * 1.4f * f2;
        this.leftHindLeg.xRot = Mth.cos(f3 * 0.6662f + (float)Math.PI) * 1.4f * f2;
        this.rightFrontLeg.xRot = Mth.cos(f3 * 0.6662f + (float)Math.PI) * 1.4f * f2;
        this.leftFrontLeg.xRot = Mth.cos(f3 * 0.6662f) * 1.4f * f2;
        this.head.zRot = foxRenderState.headRollAngle;
        this.rightHindLeg.visible = true;
        this.leftHindLeg.visible = true;
        this.rightFrontLeg.visible = true;
        this.leftFrontLeg.visible = true;
        float f4 = foxRenderState.ageScale;
        if (foxRenderState.isCrouching) {
            this.body.xRot += 0.10471976f;
            f = foxRenderState.crouchAmount;
            this.body.y += f * f4;
            this.head.y += f * f4;
            ...
            this.rightHindLeg.y += 4.0f * f4;
            this.rightHindLeg.z -= 0.25f * f4;
            this.leftHindLeg.xRot = -1.3089969f;
            this.leftHindLeg.y += 4.0f * f4;
            this.leftHindLeg.z -= 0.25f * f4;
        ...
        if (foxRenderState.isCrouching) {
            this.body.yRot = f = Mth.cos(foxRenderState.ageInTicks) * 0.01f;
