...
public class GameProtocols {
    public static final CodecModifier<RegistryFriendlyByteBuf, ServerboundSetCreativeModeSlotPacket, Context> HAS_INFINITE_MATERIALS = (streamCodec, context) -> new StreamCodec<RegistryFriendlyByteBuf, ServerboundSetCreativeModeSlotPacket>(){

        @Override
        public ServerboundSetCreativeModeSlotPacket decode(RegistryFriendlyByteBuf registryFriendlyByteBuf) {
            if (!context.hasInfiniteMaterials()) {
                throw new SkipPacketDecoderException("Not in creative mode");
            }
            return (ServerboundSetCreativeModeSlotPacket)streamCodec.decode(registryFriendlyByteBuf);
        }

        @Override
        public void encode(RegistryFriendlyByteBuf registryFriendlyByteBuf, ServerboundSetCreativeModeSlotPacket serverboundSetCreativeModeSlotPacket) {
            if (!context.hasInfiniteMaterials()) {
                throw new SkipPacketEncoderException("Not in creative mode");
            }
            streamCodec.encode(registryFriendlyByteBuf, serverboundSetCreativeModeSlotPacket);
        }
