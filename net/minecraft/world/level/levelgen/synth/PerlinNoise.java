...
public class PerlinNoise {
    ...
    public static PerlinNoise createLegacyForLegacyNetherBiome(RandomSource randomSource, int n, DoubleList doubleList) {
        return new PerlinNoise(randomSource, (Pair<Integer, DoubleList>)Pair.of((Object)n, (Object)doubleList), false);
    }
    ...
    public static PerlinNoise create(RandomSource randomSource, int n, double d, double ... dArray) {
        ...
        return new PerlinNoise(randomSource, (Pair<Integer, DoubleList>)Pair.of((Object)n, (Object)doubleArrayList), true);
    }

    public static PerlinNoise create(RandomSource randomSource, int n, DoubleList doubleList) {
        return new PerlinNoise(randomSource, (Pair<Integer, DoubleList>)Pair.of((Object)n, (Object)doubleList), true);
    }
