...
extends MoveToBlockGoal {
            ...
            if (this.ticksSinceReachedGoal > 60) {
                ...
                if (!level.isClientSide) {
                    for (int i = 0; i < 20; ++i) {
                        ...
                        ((ServerLevel)level).sendParticles(ParticleTypes.POOF, (double)blockPos2.getX() + 0.5, blockPos2.getY(), (double)blockPos2.getZ() + 0.5, 1, d, d2, d3, 0.15f);
                    }
    ...
    private BlockPos getPosWithBlock(BlockPos blockPos, BlockGetter blockGetter) {
        ...
        for (BlockPos blockPos2 : blockPosArray = new BlockPos[]{blockPos.below(), blockPos.west(), blockPos.east(), blockPos.north(), blockPos.south(), blockPos.below().below()}) {
