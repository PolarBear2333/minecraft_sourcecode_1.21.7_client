...
public class CreativeModeTabs {
    ...
    public static CreativeModeTab bootstrap(Registry<CreativeModeTab> registry) {
        Registry.register(registry, BUILDING_BLOCKS, CreativeModeTab.builder(CreativeModeTab.Row.TOP, 0).title(Component.translatable("itemGroup.buildingBlocks")).icon(() -> new ItemStack(Blocks.BRICKS)).displayItems((itemDisplayParameters, output) -> {
        ...
        Registry.register(registry, COLORED_BLOCKS, CreativeModeTab.builder(CreativeModeTab.Row.TOP, 1).title(Component.translatable("itemGroup.coloredBlocks")).icon(() -> new ItemStack(Blocks.CYAN_WOOL)).displayItems((itemDisplayParameters, output) -> {
        ...
        Registry.register(registry, NATURAL_BLOCKS, CreativeModeTab.builder(CreativeModeTab.Row.TOP, 2).title(Component.translatable("itemGroup.natural")).icon(() -> new ItemStack(Blocks.GRASS_BLOCK)).displayItems((itemDisplayParameters, output) -> {
            ...
            output.accept(Items.CACTUS_FLOWER);
            ...
            output.accept(Items.WILDFLOWERS);
            output.accept(Items.LEAF_LITTER);
            output.accept(Items.SPORE_BLOSSOM);
            output.accept(Items.FIREFLY_BUSH);
        ...
        Registry.register(registry, FUNCTIONAL_BLOCKS, CreativeModeTab.builder(CreativeModeTab.Row.TOP, 3).title(Component.translatable("itemGroup.functional")).icon(() -> new ItemStack(Items.OAK_SIGN)).displayItems((itemDisplayParameters, output) -> {
            ...
            itemDisplayParameters.holders().lookup(Registries.PAINTING_VARIANT).ifPresent(registryLookup -> CreativeModeTabs.generatePresetPaintings(output, itemDisplayParameters.holders(), registryLookup, holder -> holder.is(PaintingVariantTags.PLACEABLE), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS));
        ...
        Registry.register(registry, REDSTONE_BLOCKS, CreativeModeTab.builder(CreativeModeTab.Row.TOP, 4).title(Component.translatable("itemGroup.redstone")).icon(() -> new ItemStack(Items.REDSTONE)).displayItems((itemDisplayParameters, output) -> {
        ...
        Registry.register(registry, SEARCH, CreativeModeTab.builder(CreativeModeTab.Row.TOP, 6).title(Component.translatable("itemGroup.search")).icon(() -> new ItemStack(Items.COMPASS)).displayItems((itemDisplayParameters, output) -> {
        ...
        Registry.register(registry, TOOLS_AND_UTILITIES, CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 0).title(Component.translatable("itemGroup.tools")).icon(() -> new ItemStack(Items.DIAMOND_PICKAXE)).displayItems((itemDisplayParameters, output) -> {
            ...
            output.accept(Items.LIGHT_GRAY_HARNESS);
            output.accept(Items.GRAY_HARNESS);
            output.accept(Items.BLACK_HARNESS);
            output.accept(Items.BROWN_HARNESS);
            output.accept(Items.RED_HARNESS);
            output.accept(Items.ORANGE_HARNESS);
            output.accept(Items.YELLOW_HARNESS);
            output.accept(Items.LIME_HARNESS);
            output.accept(Items.GREEN_HARNESS);
            output.accept(Items.CYAN_HARNESS);
            output.accept(Items.LIGHT_BLUE_HARNESS);
            output.accept(Items.BLUE_HARNESS);
            output.accept(Items.PURPLE_HARNESS);
            output.accept(Items.MAGENTA_HARNESS);
            output.accept(Items.PINK_HARNESS);
        ...
        Registry.register(registry, COMBAT, CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 1).title(Component.translatable("itemGroup.combat")).icon(() -> new ItemStack(Items.NETHERITE_SWORD)).displayItems((itemDisplayParameters, output) -> {
            ...
            itemDisplayParameters.holders().lookup(Registries.POTION).ifPresent(registryLookup -> CreativeModeTabs.generatePotionEffectTypes(output, registryLookup, Items.TIPPED_ARROW, CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS, itemDisplayParameters.enabledFeatures()));
        }).build());
        Registry.register(registry, FOOD_AND_DRINKS, CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 2).title(Component.translatable("itemGroup.foodAndDrink")).icon(() -> new ItemStack(Items.GOLDEN_APPLE)).displayItems((itemDisplayParameters, output) -> {
            ...
            CreativeModeTabs.generateOminousBottles(output, CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
            itemDisplayParameters.holders().lookup(Registries.POTION).ifPresent(registryLookup -> {
                CreativeModeTabs.generatePotionEffectTypes(output, registryLookup, Items.POTION, CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS, itemDisplayParameters.enabledFeatures());
                CreativeModeTabs.generatePotionEffectTypes(output, registryLookup, Items.SPLASH_POTION, CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS, itemDisplayParameters.enabledFeatures());
                CreativeModeTabs.generatePotionEffectTypes(output, registryLookup, Items.LINGERING_POTION, CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS, itemDisplayParameters.enabledFeatures());
            });
        }).build());
        Registry.register(registry, INGREDIENTS, CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 3).title(Component.translatable("itemGroup.ingredients")).icon(() -> new ItemStack(Items.IRON_INGOT)).displayItems((itemDisplayParameters, output) -> {
            ...
            itemDisplayParameters.holders().lookup(Registries.ENCHANTMENT).ifPresent(registryLookup -> {
                CreativeModeTabs.generateEnchantmentBookTypesOnlyMaxLevel(output, registryLookup, CreativeModeTab.TabVisibility.PARENT_TAB_ONLY);
                CreativeModeTabs.generateEnchantmentBookTypesAllLevels(output, registryLookup, CreativeModeTab.TabVisibility.SEARCH_TAB_ONLY);
            });
        }).build());
        Registry.register(registry, SPAWN_EGGS, CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 4).title(Component.translatable("itemGroup.spawnEggs")).icon(() -> new ItemStack(Items.CREEPER_SPAWN_EGG)).displayItems((itemDisplayParameters, output) -> {
        ...
        Registry.register(registry, OP_BLOCKS, CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 5).title(Component.translatable("itemGroup.op")).icon(() -> new ItemStack(Items.COMMAND_BLOCK)).alignedRight().displayItems((itemDisplayParameters, output) -> {
            if (itemDisplayParameters.hasPermissions()) {
                ...
                output.accept(Items.TEST_INSTANCE_BLOCK);
                for (TestBlockMode testBlockMode : TestBlockMode.values()) {
                    output.accept(TestBlock.setModeOnStack(new ItemStack(Items.TEST_BLOCK), testBlockMode));
                }
                for (int i = 15; i >= 0; --i) {
    ...
    public static void validate() {
        ...
        for (ResourceKey<CreativeModeTab> resourceKey : BuiltInRegistries.CREATIVE_MODE_TAB.registryKeySet()) {
            ...
            String string2 = hashMap.put(Pair.of((Object)((Object)creativeModeTab.row()), (Object)creativeModeTab.column()), string);
    ...
    private static void generatePotionEffectTypes(CreativeModeTab.Output output, HolderLookup<Potion> holderLookup, Item item, CreativeModeTab.TabVisibility tabVisibility, FeatureFlagSet featureFlagSet) {
        holderLookup.listElements().filter(reference -> ((Potion)reference.value()).isEnabled(featureFlagSet)).map(reference -> PotionContents.createItemStack(item, reference)).forEach(itemStack -> output.accept((ItemStack)itemStack, tabVisibility));
    }
    ...
    private static void generateEnchantmentBookTypesOnlyMaxLevel(CreativeModeTab.Output output, HolderLookup<Enchantment> holderLookup, CreativeModeTab.TabVisibility tabVisibility) {
        holderLookup.listElements().map(reference -> EnchantmentHelper.createBook(new EnchantmentInstance((Holder<Enchantment>)reference, ((Enchantment)reference.value()).getMaxLevel()))).forEach(itemStack -> output.accept((ItemStack)itemStack, tabVisibility));
    }
    ...
    private static void generateEnchantmentBookTypesAllLevels(CreativeModeTab.Output output, HolderLookup<Enchantment> holderLookup, CreativeModeTab.TabVisibility tabVisibility) {
        holderLookup.listElements().flatMap(reference -> IntStream.rangeClosed(((Enchantment)reference.value()).getMinLevel(), ((Enchantment)reference.value()).getMaxLevel()).mapToObj(n -> EnchantmentHelper.createBook(new EnchantmentInstance((Holder<Enchantment>)reference, n)))).forEach(itemStack -> output.accept((ItemStack)itemStack, tabVisibility));
    }
    ...
    private static void generateFireworksAllDurations(CreativeModeTab.Output output, CreativeModeTab.TabVisibility tabVisibility) {
        for (byte by : FireworkRocketItem.CRAFTABLE_DURATIONS) {
            ItemStack itemStack = new ItemStack(Items.FIREWORK_ROCKET);
            itemStack.set(DataComponents.FIREWORKS, new Fireworks(by, List.of()));
            output.accept(itemStack, tabVisibility);
        }
    }
    ...
    private static void buildAllTabContents(CreativeModeTab.ItemDisplayParameters itemDisplayParameters) {
        CreativeModeTabs.streamAllTabs().filter(creativeModeTab -> creativeModeTab.getType() == CreativeModeTab.Type.CATEGORY).forEach(creativeModeTab -> creativeModeTab.buildContents(itemDisplayParameters));
        CreativeModeTabs.streamAllTabs().filter(creativeModeTab -> creativeModeTab.getType() != CreativeModeTab.Type.CATEGORY).forEach(creativeModeTab -> creativeModeTab.buildContents(itemDisplayParameters));
    }
