...
implements SelectItemModelProperty<String> {
    ...
    public static final SelectItemModelProperty.Type<LocalTime, String> TYPE = SelectItemModelProperty.Type.create(DATA_MAP_CODEC.flatXmap(LocalTime::create, localTime -> DataResult.success((Object)localTime.data)), VALUE_CODEC);
    ...
    public static LocalTime create(String string2, String string3, Optional<TimeZone> optional) {
        return (LocalTime)LocalTime.create(new Data(string2, string3, optional)).getOrThrow(string -> new IllegalStateException("Failed to validate format: " + string));
    }
