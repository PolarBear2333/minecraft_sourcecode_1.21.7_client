...
extends ParserBasedArgument<Style> {
    ...
    public static final DynamicCommandExceptionType ERROR_INVALID_STYLE = new DynamicCommandExceptionType(object -> Component.translatableEscape("argument.style.invalid", object));
    ...
    public static Style getStyle(CommandContext<CommandSourceStack> commandContext, String string) {
        return (Style)commandContext.getArgument(string, Style.class);
    }
