...
extends Behavior<Mob> {
    ...
    public MoveToTargetSink(int n, int n2) {
        super((Map<MemoryModuleType<?>, MemoryStatus>)ImmutableMap.of(MemoryModuleType.CANT_REACH_WALK_TARGET_SINCE, (Object)((Object)MemoryStatus.REGISTERED), MemoryModuleType.PATH, (Object)((Object)MemoryStatus.VALUE_ABSENT), MemoryModuleType.WALK_TARGET, (Object)((Object)MemoryStatus.VALUE_PRESENT)), n, n2);
    }
    ...
    protected boolean canStillUse(ServerLevel serverLevel, Mob mob, long l) {
        ...
        return !pathNavigation.isDone() && optional.isPresent() && !this.reachedTarget(mob, optional.get()) && !bl;
    }
