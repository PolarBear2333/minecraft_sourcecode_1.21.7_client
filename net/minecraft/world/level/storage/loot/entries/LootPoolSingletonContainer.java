...
extends LootPoolEntryContainer {
    ...
    protected LootPoolSingletonContainer(int n, int n2, List<LootItemCondition> list, List<LootItemFunction> list2) {
        super(list);
        this.weight = n;
        this.quality = n2;
