...
public class GoalUtils {
    ...
    public static boolean mobRestricted(PathfinderMob pathfinderMob, int n) {
        return pathfinderMob.hasHome() && pathfinderMob.getHomePosition().closerToCenterThan(pathfinderMob.position(), pathfinderMob.getHomeRadius() + n + 1);
    }
