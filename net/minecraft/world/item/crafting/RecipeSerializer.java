...
public interface RecipeSerializer<T extends Recipe<?>> {
    ...
    public static <S extends RecipeSerializer<T>, T extends Recipe<?>> S register(String string, S s) {
        return (S)Registry.register(BuiltInRegistries.RECIPE_SERIALIZER, string, s);
    }
}
