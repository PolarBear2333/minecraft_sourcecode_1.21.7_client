...
extends NamespacedSchema {
    ...
    public Map<String, Supplier<TypeTemplate>> registerEntities(Schema schema) {
        ...
        schema.register(map, "minecraft:llama", string -> V4300.entityWithInventory(schema));
        schema.register(map, "minecraft:trader_llama", string -> V4300.entityWithInventory(schema));
        schema.register(map, "minecraft:donkey", string -> V4300.entityWithInventory(schema));
        schema.register(map, "minecraft:mule", string -> V4300.entityWithInventory(schema));
