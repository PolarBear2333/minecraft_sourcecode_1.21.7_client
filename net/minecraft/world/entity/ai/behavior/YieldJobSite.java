...
public class YieldJobSite {
    ...
    private static boolean nearbyWantsJobsite(Holder<PoiType> holder, Villager villager, BlockPos blockPos) {
        ...
        Holder<VillagerProfession> holder2 = villager.getVillagerData().profession();
        if (holder2.value().heldJobSite().test(holder)) {
            if (optional.isEmpty()) {
