...
public class NoiseRouterData {
    ...
    public static Holder<? extends DensityFunction> bootstrap(BootstrapContext<DensityFunction> bootstrapContext) {
        ...
        int n = DimensionType.MIN_Y * 2;
        int n2 = DimensionType.MAX_Y * 2;
        bootstrapContext.register(Y, DensityFunctions.yClampedGradient(n, n2, n, n2));
        DensityFunction densityFunction = NoiseRouterData.registerAndWrap(bootstrapContext, SHIFT_X, DensityFunctions.flatCache(DensityFunctions.cache2d(DensityFunctions.shiftA(holderGetter.getOrThrow(Noises.SHIFT)))));
        DensityFunction densityFunction2 = NoiseRouterData.registerAndWrap(bootstrapContext, SHIFT_Z, DensityFunctions.flatCache(DensityFunctions.cache2d(DensityFunctions.shiftB(holderGetter.getOrThrow(Noises.SHIFT)))));
        ...
        Holder.Reference<DensityFunction> reference = bootstrapContext.register(CONTINENTS, DensityFunctions.flatCache(DensityFunctions.shiftedNoise2d(densityFunction, densityFunction2, 0.25, holderGetter.getOrThrow(Noises.CONTINENTALNESS))));
        Holder.Reference<DensityFunction> reference2 = bootstrapContext.register(EROSION, DensityFunctions.flatCache(DensityFunctions.shiftedNoise2d(densityFunction, densityFunction2, 0.25, holderGetter.getOrThrow(Noises.EROSION))));
        DensityFunction densityFunction3 = NoiseRouterData.registerAndWrap(bootstrapContext, RIDGES, DensityFunctions.flatCache(DensityFunctions.shiftedNoise2d(densityFunction, densityFunction2, 0.25, holderGetter.getOrThrow(Noises.RIDGE))));
        bootstrapContext.register(RIDGES_FOLDED, NoiseRouterData.peaksAndValleys(densityFunction3));
        DensityFunction densityFunction4 = DensityFunctions.noise(holderGetter.getOrThrow(Noises.JAGGED), 1500.0, 0.0);
        NoiseRouterData.registerTerrainNoises(bootstrapContext, holderGetter2, densityFunction4, reference, reference2, OFFSET, FACTOR, JAGGEDNESS, DEPTH, SLOPED_CHEESE, false);
        Holder.Reference<DensityFunction> reference3 = bootstrapContext.register(CONTINENTS_LARGE, DensityFunctions.flatCache(DensityFunctions.shiftedNoise2d(densityFunction, densityFunction2, 0.25, holderGetter.getOrThrow(Noises.CONTINENTALNESS_LARGE))));
        Holder.Reference<DensityFunction> reference4 = bootstrapContext.register(EROSION_LARGE, DensityFunctions.flatCache(DensityFunctions.shiftedNoise2d(densityFunction, densityFunction2, 0.25, holderGetter.getOrThrow(Noises.EROSION_LARGE))));
        NoiseRouterData.registerTerrainNoises(bootstrapContext, holderGetter2, densityFunction4, reference3, reference4, OFFSET_LARGE, FACTOR_LARGE, JAGGEDNESS_LARGE, DEPTH_LARGE, SLOPED_CHEESE_LARGE, false);
        NoiseRouterData.registerTerrainNoises(bootstrapContext, holderGetter2, densityFunction4, reference, reference2, OFFSET_AMPLIFIED, FACTOR_AMPLIFIED, JAGGEDNESS_AMPLIFIED, DEPTH_AMPLIFIED, SLOPED_CHEESE_AMPLIFIED, true);
        bootstrapContext.register(SLOPED_CHEESE_END, DensityFunctions.add(DensityFunctions.endIslands(0L), NoiseRouterData.getFunction(holderGetter2, BASE_3D_NOISE_END)));
        bootstrapContext.register(SPAGHETTI_ROUGHNESS_FUNCTION, NoiseRouterData.spaghettiRoughnessFunction(holderGetter));
        bootstrapContext.register(SPAGHETTI_2D_THICKNESS_MODULATOR, DensityFunctions.cacheOnce(DensityFunctions.mappedNoise(holderGetter.getOrThrow(Noises.SPAGHETTI_2D_THICKNESS), 2.0, 1.0, -0.6, -1.3)));
        bootstrapContext.register(SPAGHETTI_2D, NoiseRouterData.spaghetti2D(holderGetter2, holderGetter));
        bootstrapContext.register(ENTRANCES, NoiseRouterData.entrances(holderGetter2, holderGetter));
        bootstrapContext.register(NOODLE, NoiseRouterData.noodle(holderGetter2, holderGetter));
        return bootstrapContext.register(PILLARS, NoiseRouterData.pillars(holderGetter));
    }
    ...
    private static void registerTerrainNoises(BootstrapContext<DensityFunction> bootstrapContext, HolderGetter<DensityFunction> holderGetter, DensityFunction densityFunction, Holder<DensityFunction> holder, Holder<DensityFunction> holder2, ResourceKey<DensityFunction> resourceKey, ResourceKey<DensityFunction> resourceKey2, ResourceKey<DensityFunction> resourceKey3, ResourceKey<DensityFunction> resourceKey4, ResourceKey<DensityFunction> resourceKey5, boolean bl) {
        ...
        DensityFunction densityFunction2 = NoiseRouterData.registerAndWrap(bootstrapContext, resourceKey, NoiseRouterData.splineWithBlending(DensityFunctions.add(DensityFunctions.constant(-0.50375f), DensityFunctions.spline(TerrainProvider.overworldOffset(coordinate, coordinate2, coordinate4, bl))), DensityFunctions.blendOffset()));
        DensityFunction densityFunction3 = NoiseRouterData.registerAndWrap(bootstrapContext, resourceKey2, NoiseRouterData.splineWithBlending(DensityFunctions.spline(TerrainProvider.overworldFactor(coordinate, coordinate2, coordinate3, coordinate4, bl)), BLENDING_FACTOR));
        DensityFunction densityFunction4 = NoiseRouterData.registerAndWrap(bootstrapContext, resourceKey4, DensityFunctions.add(DensityFunctions.yClampedGradient(-64, 320, 1.5, -1.5), densityFunction2));
        DensityFunction densityFunction5 = NoiseRouterData.registerAndWrap(bootstrapContext, resourceKey3, NoiseRouterData.splineWithBlending(DensityFunctions.spline(TerrainProvider.overworldJaggedness(coordinate, coordinate2, coordinate3, coordinate4, bl)), BLENDING_JAGGEDNESS));
        ...
        bootstrapContext.register(resourceKey5, DensityFunctions.add(densityFunction7, NoiseRouterData.getFunction(holderGetter, BASE_3D_NOISE_OVERWORLD)));
    }
    ...
    protected static NoiseRouter overworld(HolderGetter<DensityFunction> holderGetter, HolderGetter<NormalNoise.NoiseParameters> holderGetter2, boolean bl, boolean bl2) {
        ...
        int n = Stream.of(OreVeinifier.VeinType.values()).mapToInt(veinType -> veinType.minY).min().orElse(-DimensionType.MIN_Y * 2);
        int n2 = Stream.of(OreVeinifier.VeinType.values()).mapToInt(veinType -> veinType.maxY).max().orElse(-DimensionType.MIN_Y * 2);
        DensityFunction densityFunction17 = NoiseRouterData.yLimitedInterpolatable(densityFunction16, DensityFunctions.noise(holderGetter2.getOrThrow(Noises.ORE_VEININESS), 1.5, 1.5), n, n2, 0);
        float f = 4.0f;
        DensityFunction densityFunction18 = NoiseRouterData.yLimitedInterpolatable(densityFunction16, DensityFunctions.noise(holderGetter2.getOrThrow(Noises.ORE_VEIN_A), 4.0, 4.0), n, n2, 0).abs();
        DensityFunction densityFunction19 = NoiseRouterData.yLimitedInterpolatable(densityFunction16, DensityFunctions.noise(holderGetter2.getOrThrow(Noises.ORE_VEIN_B), 4.0, 4.0), n, n2, 0).abs();
    ...
    private static DensityFunction slideNetherLike(HolderGetter<DensityFunction> holderGetter, int n, int n2) {
        return NoiseRouterData.slide(NoiseRouterData.getFunction(holderGetter, BASE_3D_NOISE_NETHER), n, n2, 24, 0, 0.9375, -8, 24, 2.5);
    }

    private static DensityFunction slideEndLike(DensityFunction densityFunction, int n, int n2) {
        return NoiseRouterData.slide(densityFunction, n, n2, 72, -184, -23.4375, 4, 32, -0.234375);
    }
    ...
    private static DensityFunction yLimitedInterpolatable(DensityFunction densityFunction, DensityFunction densityFunction2, int n, int n2, int n3) {
        return DensityFunctions.interpolated(DensityFunctions.rangeChoice(densityFunction, n, n2 + 1, densityFunction2, DensityFunctions.constant(n3)));
    }

    private static DensityFunction slide(DensityFunction densityFunction, int n, int n2, int n3, int n4, double d, int n5, int n6, double d2) {
        DensityFunction densityFunction2 = densityFunction;
        DensityFunction densityFunction3 = DensityFunctions.yClampedGradient(n + n2 - n3, n + n2 - n4, 1.0, 0.0);
        densityFunction2 = DensityFunctions.lerp(densityFunction3, d, densityFunction2);
        DensityFunction densityFunction4 = DensityFunctions.yClampedGradient(n + n5, n + n6, 0.0, 1.0);
        densityFunction2 = DensityFunctions.lerp(densityFunction4, d2, densityFunction2);
