...
extends RealmsScreen {
    ...
    extends Button {
        ...
        public void renderWidget(GuiGraphics guiGraphics, int n, int n2, float f) {
            ...
            int n4 = this.getX();
            int n5 = this.getY();
            guiGraphics.blit(RenderPipelines.GUI_TEXTURED, this.image, n4 + 2, n5 + 2, 0.0f, 0.0f, 56, 56, 56, 56, 56, 56, n3);
            guiGraphics.blitSprite(RenderPipelines.GUI_TEXTURED, SLOT_FRAME_SPRITE, n4, n5, 60, 60, n3);
            int n6 = bl ? -6250336 : -1;
